...
if __name__ == '__main__':
    ...
    small_dataloader = DataLoader(small_dataset, batch_size=8, shuffle=True, num_workers=2, collate_fn=detection_collate, drop_last=False)
    ...
    for epoch in range(epochs):
        ...
        # filename = "./weights_update_fulldataset_original/epoch_%d.pkl" % (epoch)
        ...
        # torch.save()    
        # print(pytorch_model.params['W1'][1, 0, 0, 0:5])
