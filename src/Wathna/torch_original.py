...
class DeepConvNetTorch(object):
    ...
    def backward(self, dout, cache):
        ...
        last_dout, grads['W7'], grads['gamma7'], grads['beta7']  = Torch_Conv_BatchNorm_ReLU.backward      (last_dout, cache['7'])
        last_dout, grads['W6'], grads['gamma6'], grads['beta6']  = Torch_Conv_BatchNorm_ReLU.backward      (last_dout, cache['6'])
        last_dout, grads['W5'], grads['gamma5'], grads['beta5']  = Torch_Conv_BatchNorm_ReLU.backward      (last_dout, cache['5'])
        last_dout, grads['W4'], grads['gamma4'], grads['beta4']  = Torch_Conv_BatchNorm_ReLU_Pool.backward (last_dout, cache['4'])
        last_dout, grads['W3'], grads['gamma3'], grads['beta3']  = Torch_Conv_BatchNorm_ReLU_Pool.backward (last_dout, cache['3'])
        last_dout, grads['W2'], grads['gamma2'], grads['beta2']  = Torch_Conv_BatchNorm_ReLU_Pool.backward (last_dout, cache['2'])
        last_dout, grads['W1'], grads['gamma1'], grads['beta1']  = Torch_Conv_BatchNorm_ReLU_Pool.backward (last_dout, cache['1'])
        last_dout, grads['W0'], grads['gamma0'], grads['beta0']  = Torch_Conv_BatchNorm_ReLU_Pool.backward (last_dout, cache['0'])
        # print(f"\n\t grads['W0']\n\t\t{grads['W0'].shape}\n\t\t{grads['W0'][grads['W0']!=0]}\n")
