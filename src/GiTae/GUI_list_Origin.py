...
class YOLOv2_Tiny_FPGA(object):
    ...
    def Forward(self):
        global layer0_cache, layer1_cache, layer2_cache, layer3_cache, layer4_cache, layer5_cache, layer6_cache, layer7_cache, Loss
        start = time.time()
        #################################################
        #                Layer 0 Start                  #
        #################################################       
    ...
    def Backward(self):
        ...
        e = time.time()
        print("Read Output Gradient Layer8 Time : ", e-s)
        ...
        e = time.time()
        print("Read ReLu Marking Time : ", e-s)
        ...
        e = time.time()
        print("Mean Var Dec2Bfloat Time : ", e-s)
        ...
        e = time.time()
        print("Read Weight Gradient Layer8 Time : ", e-s)
        ...
        e = time.time()
        print("Break_FlipHex_256To32 Time : ", e-s)
    ...
    def Write_Image(self):
        ...
        if Image_Converted: 
                ...
                # Break 256To32 and Flip the Data: 
                Images_CH0 = Break_FlipHex_256To32(Images_CH0)
                Images_CH1 = Break_FlipHex_256To32(Images_CH1)
