...
def Read_DDR(Rd_Address, End_Address):
    device = XdmaAccess(0)
    Read_Data_List = device.read_dma(Rd_Address, int((End_Address-Rd_Address)))
...
def Forward(epoch):
    ...
    # gamma_dec_list0 = []
    # beta_dec_list0 = []
    # gamma_dec_list0.clear()
    # beta_dec_list0.clear()
    
    # for Value in Gamma_List[0][:(len(Gamma_List[0]))]:
    ...
    #     gamma_dec_list0.append(str(Decimal))   

    # for Value in Beta_List[0][:(len(Beta_List[0]))]:
    #     Hexadecimal = str(Value) + "0000"
    #     Binary_Value = bin(int(Hexadecimal, 16))[2:].zfill(32)
    #     Decimal = Binary2Floating(Binary_Value, Exponent_Bits, Mantissa_Bits)
    #     beta_dec_list0.append(str(Decimal))          
            ...
            open(output_file_name_2, "r") as file2:
                ...
                while ch1 and ch2:
                    if ch1 != ch2:
                        ...
                        irq_val = 1
                        # L1_IRQ_canvas.itemconfig(L2_IRQ, fill="green")
                    ch1 = file1.read(1)
                    ch2 = file2.read(1)
            ...
            open(output_file_name_2, "r") as file2:
                ...
                while ch1 and ch2:
                    if ch1 != ch2:
                        ...
                        irq_val = 1
                        # L1_IRQ_canvas.itemconfig(L3_IRQ, fill="green")
                    ch1 = file1.read(1)
                    ch2 = file2.read(1)
            ...
            open(output_file_name_2, "r") as file2:
                ...
                while ch1 and ch2:
                    if ch1 != ch2:
                        ...
                        irq_val = 1
                        # L1_IRQ_canvas.itemconfig(L4_IRQ, fill="green")
                    ch1 = file1.read(1)
                    ch2 = file2.read(1)
            ...
            open(output_file_name_2, "r") as file2:
                ...
                while ch1 and ch2:
                    if ch1 != ch2:
                        ...
                        irq_val = 1
                        # L1_IRQ_canvas.itemconfig(L5_IRQ, fill="green")
                    ch1 = file1.read(1)
                    ch2 = file2.read(1)
            ...
            open(output_file_name_2, "r") as file2:
                ...
                while ch1 and ch2:
                    if ch1 != ch2:
                        ...
                        irq_val = 1
                        # L1_IRQ_canvas.itemconfig(L6_IRQ, fill="green")
                    ch1 = file1.read(1)
                    ch2 = file2.read(1)
            ...
            open(output_file_name_2, "r") as file2:
                ...
                while ch1 and ch2:
                    if ch1 != ch2:
                        ...
                        irq_val = 1
                        # L1_IRQ_canvas.itemconfig(L7_IRQ, fill="green")
                    ch1 = file1.read(1)
                    ch2 = file2.read(1)
    ...
    print("Layer5 process time : ", layer7_process)
    ...
    while irq_val == 0:                        
        ...
        with open(output_file_name_1, "r") as file1, \
            open(output_file_name_2, "r") as file2:
                ...
                while ch1 and ch2:
                    if ch1 != ch2:
                        print("layer8 interrupt: 1")
                        irq_val = 1
                        #L1_IRQ_canvas.itemconfig(L8_IRQ, fill="green")
                    ch1 = file1.read(1)
                    ch2 = file2.read(1)

                # if irq_val != 1:
                #     print("layer8 interrupt: 0")
...
def Backward():
    ...
    ReLu_Marking1_Layer7_CH0 = Read_DDR(Rd_Address=0x80D4000,  End_Address=0x8108000)
    ReLu_Marking1_Layer7_CH0_256 = process_input_lines(ReLu_Marking1_Layer7_CH0)

    ReLu_Marking2_Layer7_CH0 = Read_DDR(Rd_Address=0x8108000,  End_Address=0x813C000)
    ReLu_Marking2_Layer7_CH0_256 = process_input_lines(ReLu_Marking2_Layer7_CH0)

    ReLu_Marking3_Layer7_CH0 = Read_DDR(Rd_Address=0x813C000,  End_Address=0x8170000)
    ReLu_Marking3_Layer7_CH0_256 = process_input_lines(ReLu_Marking3_Layer7_CH0)

    ReLu_Marking4_Layer7_CH0 = Read_DDR(Rd_Address=0x8170000,  End_Address=0x81A4000)
    ReLu_Marking4_Layer7_CH0_256 = process_input_lines(ReLu_Marking4_Layer7_CH0)

    ReLu_Marking5_Layer7_CH0 = Read_DDR(Rd_Address=0x81A4000,  End_Address=0x81D8000)
    ReLu_Marking5_Layer7_CH0_256 = process_input_lines(ReLu_Marking5_Layer7_CH0)

    ReLu_Marking6_Layer7_CH0 = Read_DDR(Rd_Address=0x81D8000,  End_Address=0x820C000)
    ReLu_Marking6_Layer7_CH0_256 = process_input_lines(ReLu_Marking6_Layer7_CH0)

    ReLu_Marking7_Layer7_CH0 = Read_DDR(Rd_Address=0x820C000,  End_Address=0x8240000)
    ReLu_Marking7_Layer7_CH0_256 = process_input_lines(ReLu_Marking7_Layer7_CH0)

    ReLu_Marking8_Layer7_CH0 = Read_DDR(Rd_Address=0x8240000,  End_Address=0x8274000)
    ...
    Weight_Gradient5_Layer8_CH0 = Read_DDR(Rd_Address=0x8835C000,  End_Address=0X837C000)
    ...
    Weight_Gradient6_Layer8_CH0 = Read_DDR(Rd_Address=0X837C000,  End_Address=0x8839C000)
