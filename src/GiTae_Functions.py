...
def Read_DDR0(Rd_Address, End_Address):
    device = XdmaAccess(0)
    Read_Data_List = device.read_dma0(Rd_Address, ((End_Address-Rd_Address)))
    # if DEBUG: print("Read_Data_List : ", Read_Data_List)
    device.__close__()
    return Read_Data_List  
...
def flip_lines_16(data):
    flipped_data = []

    for i in range(0, len(data), 16):
        chunk = data[i:i + 16]
        chunk = chunk[::-1] 
        flipped_data.extend(chunk)
        
    for i in range(0, len(flipped_data), 2):
        chunk = data[i:i]
        chunk = chunk[::-1] 
        flipped_data.extend(chunk)
    return flipped_data   
...
def flip_lines_16(data):
    ...
    num_chunks = data_length // 16
    if num_chunks == 0:
        return [] 
    chunks = np.array(data[:num_chunks * 16]).reshape(num_chunks, 16)
    flipped_chunks = np.flip(chunks, axis=1)
    flipped_data = flipped_chunks.flatten()
    return flipped_data.tolist()  
...
def backward_MaxPool_Location(dout, Location, layer_no=[], save_txt=False, save_hex=False, phase=[]):
    ...
    for n, c, height, width in itertools.product(range(N),range(C), range(H_out), range(W_out)):
...
def backward_MaxPool_Location(dout, Location):
    N, C, H, W = Location.shape
    H = 2 * H
    W = 2 * W
    stride = 2
    ...
    dx = torch.zeros(N, C, H, W, device=dout.device)
    
    indices = torch.arange(H_out * W_out, device=dout.device).view(H_out, W_out)
    
    for n in range(N):
        for c in range(C):
            local_douts = dout[n, c, :H_out, :W_out]
            local_locations = Location[n, c, :H_out, :W_out].long()
            
            loc_flat = local_locations.flatten()
            dh = loc_flat // pool_width
            dw = loc_flat % pool_width
            
            indices_flat = indices.flatten()
            h_idx = indices_flat // W_out
            w_idx = indices_flat % W_out
            
            dx[n, c, h_idx * stride + dh, w_idx * stride + dw] = local_douts.flatten()
...
class YOLOv2_Tiny_FPGA(object):
    ...
    def Forward(self,data):
        ...
        Layer0_1st_Iter_Image1_CH0_256 = flip_lines_16(Layer0_1st_Iter_Image1_CH0) 
        ...
        Layer0_1st_Iter_Image2_CH0_256 = flip_lines_16(Layer0_1st_Iter_Image2_CH0)
        ...
        Layer0_1st_Iter_Image3_CH0_256 = flip_lines_16(Layer0_1st_Iter_Image3_CH0)
        ...
        Layer0_1st_Iter_Image4_CH0_256 = flip_lines_16(Layer0_1st_Iter_Image4_CH0)
        ...
        Layer0_1st_Iter_Image5_CH0_256 = flip_lines_16(Layer0_1st_Iter_Image5_CH0)
        ...
        Layer0_1st_Iter_Image6_CH0_256 = flip_lines_16(Layer0_1st_Iter_Image6_CH0)
        ...
        Layer0_1st_Iter_Image7_CH0_256 = flip_lines_16(Layer0_1st_Iter_Image7_CH0)
        ...
        Layer0_1st_Iter_Image8_CH0_256 = flip_lines_16(Layer0_1st_Iter_Image8_CH0)
        ...
        Layer0_1st_Iter_Image1_CH1_256 = flip_lines_16(Layer0_1st_Iter_Image1_CH1)
        ...
        Layer0_1st_Iter_Image2_CH1_256 = flip_lines_16(Layer0_1st_Iter_Image2_CH1)
        ...
        Layer0_1st_Iter_Image3_CH1_256 = flip_lines_16(Layer0_1st_Iter_Image3_CH1)
        ...
        Layer0_1st_Iter_Image4_CH1_256 = flip_lines_16(Layer0_1st_Iter_Image4_CH1)
        ...
        Layer0_1st_Iter_Image5_CH1_256 = flip_lines_16(Layer0_1st_Iter_Image5_CH1)
        ...
        Layer0_1st_Iter_Image6_CH1_256 = flip_lines_16(Layer0_1st_Iter_Image6_CH1)
        ...
        Layer0_1st_Iter_Image7_CH1_256 = flip_lines_16(Layer0_1st_Iter_Image7_CH1)
        ...
        Layer0_1st_Iter_Image8_CH1_256 = flip_lines_16(Layer0_1st_Iter_Image8_CH1)
        ...
        # Output_Image1_Layer0_1st_Iter = np.array(Output_Image1_Layer0_1st_Iter)
        # Output_Image2_Layer0_1st_Iter = np.array(Output_Image2_Layer0_1st_Iter)
        # Output_Image3_Layer0_1st_Iter = np.array(Output_Image3_Layer0_1st_Iter)
        # Output_Image4_Layer0_1st_Iter = np.array(Output_Image4_Layer0_1st_Iter)
        # Output_Image5_Layer0_1st_Iter = np.array(Output_Image5_Layer0_1st_Iter)
        # Output_Image6_Layer0_1st_Iter = np.array(Output_Image6_Layer0_1st_Iter)
        # Output_Image7_Layer0_1st_Iter = np.array(Output_Image7_Layer0_1st_Iter)
        # Output_Image8_Layer0_1st_Iter = np.array(Output_Image8_Layer0_1st_Iter)
        ...
        Image0_2nd_ch0 = flip_lines_16(Image0_2nd_ch0)
        #if DEBUG: print("ch1 image 7 : ", len(Layer0_1st_Iter_Image7_CH1))

        Image0_2nd_ch1 = Read_DDR(Rd_Address=0X94480000, End_Address=0X94550000)
        Image0_2nd_ch1 = flip_lines_16(Image0_2nd_ch1)
        ...
        Image1_2nd_ch0 = flip_lines_16(Image1_2nd_ch0)
        #if DEBUG: print("ch1 image 7 : ", len(Layer0_1st_Iter_Image7_CH1))

        Image1_2nd_ch1 = Read_DDR(Rd_Address=0X94550000, End_Address=0X94620000)
        Image1_2nd_ch1 = flip_lines_16(Image1_2nd_ch1)
        ...
        Image2_2nd_ch0 = flip_lines_16(Image2_2nd_ch0)
        #if DEBUG: print("ch1 image 7 : ", len(Layer0_1st_Iter_Image7_CH1))

        Image2_2nd_ch1 = Read_DDR(Rd_Address=0X94620000, End_Address=0X946F0000)
        Image2_2nd_ch1 = flip_lines_16(Image2_2nd_ch1)
        ...
        Image3_2nd_ch0 = flip_lines_16(Image3_2nd_ch0)
        #if DEBUG: print("ch1 image 7 : ", len(Layer0_1st_Iter_Image7_CH1))

        Image3_2nd_ch1 = Read_DDR(Rd_Address=0X946F0000, End_Address=0X947C0000)
        Image3_2nd_ch1 = flip_lines_16(Image3_2nd_ch1)
        ...
        Image4_2nd_ch0 = flip_lines_16(Image4_2nd_ch0)
        #if DEBUG: print("ch1 image 7 : ", len(Layer0_1st_Iter_Image7_CH1))

        Image4_2nd_ch1 = Read_DDR(Rd_Address=0X947C0000, End_Address=0X94890000)
        Image4_2nd_ch1 = flip_lines_16(Image4_2nd_ch1)
        ...
        Image5_2nd_ch0 = flip_lines_16(Image5_2nd_ch0)
        #if DEBUG: print("ch1 image 7 : ", len(Layer0_1st_Iter_Image7_CH1))

        Image5_2nd_ch1 = Read_DDR(Rd_Address=0X94890000, End_Address=0X94960000)
        Image5_2nd_ch1 = flip_lines_16(Image5_2nd_ch1)
        ...
        Image6_2nd_ch0 = flip_lines_16(Image6_2nd_ch0)
        #if DEBUG: print("ch1 image 7 : ", len(Layer0_1st_Iter_Image7_CH1))

        Image6_2nd_ch1 = Read_DDR(Rd_Address=0X94960000, End_Address=0X94A30000)
        Image6_2nd_ch1 = flip_lines_16(Image6_2nd_ch1)
        ...
        Image7_2nd_ch0 = flip_lines_16(Image7_2nd_ch0)
        #if DEBUG: print("ch1 image 7 : ", len(Layer0_1st_Iter_Image7_CH1))

        Image7_2nd_ch1 = Read_DDR(Rd_Address=0X94A30000, End_Address=0X94B00000)
        Image7_2nd_ch1 = flip_lines_16(Image7_2nd_ch1)
        ...
        Layer1_1st_Iter_Image1_CH0_256 = (flip_lines_16(Layer1_1st_Iter_Image1_CH0))   
        ...
        Layer1_1st_Iter_Image2_CH0_256 = (flip_lines_16(Layer1_1st_Iter_Image2_CH0))
        ...
        Layer1_1st_Iter_Image3_CH0_256 = (flip_lines_16(Layer1_1st_Iter_Image3_CH0))
        ...
        Layer1_1st_Iter_Image4_CH0_256 = (flip_lines_16(Layer1_1st_Iter_Image4_CH0))
        ...
        Layer1_1st_Iter_Image5_CH0_256 = (flip_lines_16(Layer1_1st_Iter_Image5_CH0))
        ...
        Layer1_1st_Iter_Image6_CH0_256 = (flip_lines_16(Layer1_1st_Iter_Image6_CH0))
        ...
        Layer1_1st_Iter_Image7_CH0_256 = (flip_lines_16(Layer1_1st_Iter_Image7_CH0))
        ...
        Layer1_1st_Iter_Image8_CH0_256 = (flip_lines_16(Layer1_1st_Iter_Image8_CH0))
        ...
        Layer1_1st_Iter_Image1_CH1_256 = (flip_lines_16(Layer1_1st_Iter_Image1_CH1))
        ...
        Layer1_1st_Iter_Image2_CH1_256 = (flip_lines_16(Layer1_1st_Iter_Image2_CH1))
        ...
        Layer1_1st_Iter_Image3_CH1_256 = (flip_lines_16(Layer1_1st_Iter_Image3_CH1))
        ...
        Layer1_1st_Iter_Image4_CH1_256 = (flip_lines_16(Layer1_1st_Iter_Image4_CH1))
        ...
        Layer1_1st_Iter_Image5_CH1_256 = (flip_lines_16(Layer1_1st_Iter_Image5_CH1))
        ...
        Layer1_1st_Iter_Image6_CH1_256 = (flip_lines_16(Layer1_1st_Iter_Image6_CH1))
        ...
        Layer1_1st_Iter_Image7_CH1_256 = (flip_lines_16(Layer1_1st_Iter_Image7_CH1))
        ...
        Layer1_1st_Iter_Image8_CH1_256 = (flip_lines_16(Layer1_1st_Iter_Image8_CH1))
        ...
        Layer2_1st_Iter_Image1_CH0_256 = (flip_lines_16(Layer2_1st_Iter_Image1_CH0))   
        ...
        Layer2_1st_Iter_Image2_CH0_256 = (flip_lines_16(Layer2_1st_Iter_Image2_CH0))
        ...
        Layer2_1st_Iter_Image3_CH0_256 = (flip_lines_16(Layer2_1st_Iter_Image3_CH0))
        ...
        Layer2_1st_Iter_Image4_CH0_256 = (flip_lines_16(Layer2_1st_Iter_Image4_CH0))
        ...
        Layer2_1st_Iter_Image5_CH0_256 = (flip_lines_16(Layer2_1st_Iter_Image5_CH0))
        ...
        Layer2_1st_Iter_Image6_CH0_256 = (flip_lines_16(Layer2_1st_Iter_Image6_CH0))
        ...
        Layer2_1st_Iter_Image7_CH0_256 = (flip_lines_16(Layer2_1st_Iter_Image7_CH0))
        ...
        Layer2_1st_Iter_Image8_CH0_256 = (flip_lines_16(Layer2_1st_Iter_Image8_CH0))
        ...
        Layer2_1st_Iter_Image1_CH1_256 = (flip_lines_16(Layer2_1st_Iter_Image1_CH1))
        ...
        Layer2_1st_Iter_Image2_CH1_256 = (flip_lines_16(Layer2_1st_Iter_Image2_CH1))
        ...
        Layer2_1st_Iter_Image3_CH1_256 = (flip_lines_16(Layer2_1st_Iter_Image3_CH1))
        ...
        Layer2_1st_Iter_Image4_CH1_256 = (flip_lines_16(Layer2_1st_Iter_Image4_CH1))
        ...
        Layer2_1st_Iter_Image5_CH1_256 = (flip_lines_16(Layer2_1st_Iter_Image5_CH1))
        ...
        Layer2_1st_Iter_Image6_CH1_256 = (flip_lines_16(Layer2_1st_Iter_Image6_CH1))
        ...
        Layer2_1st_Iter_Image7_CH1_256 = (flip_lines_16(Layer2_1st_Iter_Image7_CH1))
        ...
        Layer2_1st_Iter_Image8_CH1_256 = (flip_lines_16(Layer2_1st_Iter_Image8_CH1))
        ...
        Layer3_1st_Iter_Image1_CH0_256 = (flip_lines_16(Layer3_1st_Iter_Image1_CH0))   
        ...
        Layer3_1st_Iter_Image2_CH0_256 = (flip_lines_16(Layer3_1st_Iter_Image2_CH0))
        ...
        Layer3_1st_Iter_Image3_CH0_256 = (flip_lines_16(Layer3_1st_Iter_Image3_CH0))
        ...
        Layer3_1st_Iter_Image4_CH0_256 = (flip_lines_16(Layer3_1st_Iter_Image4_CH0))
        ...
        Layer3_1st_Iter_Image5_CH0_256 = (flip_lines_16(Layer3_1st_Iter_Image5_CH0))
        ...
        Layer3_1st_Iter_Image6_CH0_256 = (flip_lines_16(Layer3_1st_Iter_Image6_CH0))
        ...
        Layer3_1st_Iter_Image7_CH0_256 = (flip_lines_16(Layer3_1st_Iter_Image7_CH0))
        ...
        Layer3_1st_Iter_Image8_CH0_256 = (flip_lines_16(Layer3_1st_Iter_Image8_CH0))
        ...
        Layer3_1st_Iter_Image1_CH1_256 = (flip_lines_16(Layer3_1st_Iter_Image1_CH1))
        ...
        Layer3_1st_Iter_Image2_CH1_256 = (flip_lines_16(Layer3_1st_Iter_Image2_CH1))
        ...
        Layer3_1st_Iter_Image3_CH1_256 = (flip_lines_16(Layer3_1st_Iter_Image3_CH1))
        ...
        Layer3_1st_Iter_Image4_CH1_256 = (flip_lines_16(Layer3_1st_Iter_Image4_CH1))
        ...
        Layer3_1st_Iter_Image5_CH1_256 = (flip_lines_16(Layer3_1st_Iter_Image5_CH1))
        ...
        Layer3_1st_Iter_Image6_CH1_256 = (flip_lines_16(Layer3_1st_Iter_Image6_CH1))
        ...
        Layer3_1st_Iter_Image7_CH1_256 = (flip_lines_16(Layer3_1st_Iter_Image7_CH1))
        ...
        Layer3_1st_Iter_Image8_CH1_256 = (flip_lines_16(Layer3_1st_Iter_Image8_CH1))
        ...
        Layer4_1st_Iter_Image1_CH0_256 = (flip_lines_16(Layer4_1st_Iter_Image1_CH0))   
        ...
        Layer4_1st_Iter_Image2_CH0_256 = (flip_lines_16(Layer4_1st_Iter_Image2_CH0))
        ...
        Layer4_1st_Iter_Image3_CH0_256 = (flip_lines_16(Layer4_1st_Iter_Image3_CH0))
        ...
        Layer4_1st_Iter_Image4_CH0_256 = (flip_lines_16(Layer4_1st_Iter_Image4_CH0))
        ...
        Layer4_1st_Iter_Image5_CH0_256 = (flip_lines_16(Layer4_1st_Iter_Image5_CH0))
        ...
        Layer4_1st_Iter_Image6_CH0_256 = (flip_lines_16(Layer4_1st_Iter_Image6_CH0))
        ...
        Layer4_1st_Iter_Image7_CH0_256 = (flip_lines_16(Layer4_1st_Iter_Image7_CH0))
        ...
        Layer4_1st_Iter_Image8_CH0_256 = (flip_lines_16(Layer4_1st_Iter_Image8_CH0))
        ...
        Layer4_1st_Iter_Image1_CH1_256 = (flip_lines_16(Layer4_1st_Iter_Image1_CH1))
        ...
        Layer4_1st_Iter_Image2_CH1_256 = (flip_lines_16(Layer4_1st_Iter_Image2_CH1))
        ...
        Layer4_1st_Iter_Image3_CH1_256 = (flip_lines_16(Layer4_1st_Iter_Image3_CH1))
        ...
        Layer4_1st_Iter_Image4_CH1_256 = (flip_lines_16(Layer4_1st_Iter_Image4_CH1))
        ...
        Layer4_1st_Iter_Image5_CH1_256 = (flip_lines_16(Layer4_1st_Iter_Image5_CH1))
        ...
        Layer4_1st_Iter_Image6_CH1_256 = (flip_lines_16(Layer4_1st_Iter_Image6_CH1))
        ...
        Layer4_1st_Iter_Image7_CH1_256 = (flip_lines_16(Layer4_1st_Iter_Image7_CH1))
        ...
        Layer4_1st_Iter_Image8_CH1_256 = (flip_lines_16(Layer4_1st_Iter_Image8_CH1))
        ...
        Layer5_1st_Iter_Image1_CH0_256 = (flip_lines_16(Layer5_1st_Iter_Image1_CH0))   
        ...
        Layer5_1st_Iter_Image2_CH0_256 = (flip_lines_16(Layer5_1st_Iter_Image2_CH0))
        ...
        Layer5_1st_Iter_Image3_CH0_256 = (flip_lines_16(Layer5_1st_Iter_Image3_CH0))
        ...
        Layer5_1st_Iter_Image4_CH0_256 = (flip_lines_16(Layer5_1st_Iter_Image4_CH0))
        ...
        Layer5_1st_Iter_Image5_CH0_256 = (flip_lines_16(Layer5_1st_Iter_Image5_CH0))
        ...
        Layer5_1st_Iter_Image6_CH0_256 = (flip_lines_16(Layer5_1st_Iter_Image6_CH0))
        ...
        Layer5_1st_Iter_Image7_CH0_256 = (flip_lines_16(Layer5_1st_Iter_Image7_CH0))
        ...
        Layer5_1st_Iter_Image8_CH0_256 = (flip_lines_16(Layer5_1st_Iter_Image8_CH0))
        ...
        Layer5_1st_Iter_Image1_CH1_256 = (flip_lines_16(Layer5_1st_Iter_Image1_CH1))
        ...
        Layer5_1st_Iter_Image2_CH1_256 = (flip_lines_16(Layer5_1st_Iter_Image2_CH1))
        ...
        Layer5_1st_Iter_Image3_CH1_256 = (flip_lines_16(Layer5_1st_Iter_Image3_CH1))
        ...
        Layer5_1st_Iter_Image4_CH1_256 = (flip_lines_16(Layer5_1st_Iter_Image4_CH1))
        ...
        Layer5_1st_Iter_Image5_CH1_256 = (flip_lines_16(Layer5_1st_Iter_Image5_CH1))
        ...
        Layer5_1st_Iter_Image6_CH1_256 = (flip_lines_16(Layer5_1st_Iter_Image6_CH1))
        ...
        Layer5_1st_Iter_Image7_CH1_256 = (flip_lines_16(Layer5_1st_Iter_Image7_CH1))
        ...
        Layer5_1st_Iter_Image8_CH1_256 = (flip_lines_16(Layer5_1st_Iter_Image8_CH1))
        ...
        Layer6_1st_Iter_Image1_CH0_256 = (flip_lines_16(Layer6_1st_Iter_Image1_CH0))   
        ...
        Layer6_1st_Iter_Image2_CH0_256 = (flip_lines_16(Layer6_1st_Iter_Image2_CH0))
        ...
        Layer6_1st_Iter_Image3_CH0_256 = (flip_lines_16(Layer6_1st_Iter_Image3_CH0))
        ...
        Layer6_1st_Iter_Image4_CH0_256 = (flip_lines_16(Layer6_1st_Iter_Image4_CH0))
        ...
        Layer6_1st_Iter_Image5_CH0_256 = (flip_lines_16(Layer6_1st_Iter_Image5_CH0))
        ...
        Layer6_1st_Iter_Image6_CH0_256 = (flip_lines_16(Layer6_1st_Iter_Image6_CH0))
        ...
        Layer6_1st_Iter_Image7_CH0_256 = (flip_lines_16(Layer6_1st_Iter_Image7_CH0))
        ...
        Layer6_1st_Iter_Image8_CH0_256 = (flip_lines_16(Layer6_1st_Iter_Image8_CH0))
        ...
        Layer6_1st_Iter_Image1_CH1_256 = (flip_lines_16(Layer6_1st_Iter_Image1_CH1))
        ...
        Layer6_1st_Iter_Image2_CH1_256 = (flip_lines_16(Layer6_1st_Iter_Image2_CH1))
        ...
        Layer6_1st_Iter_Image3_CH1_256 = (flip_lines_16(Layer6_1st_Iter_Image3_CH1))
        ...
        Layer6_1st_Iter_Image4_CH1_256 = (flip_lines_16(Layer6_1st_Iter_Image4_CH1))
        ...
        Layer6_1st_Iter_Image5_CH1_256 = (flip_lines_16(Layer6_1st_Iter_Image5_CH1))
        ...
        Layer6_1st_Iter_Image6_CH1_256 = (flip_lines_16(Layer6_1st_Iter_Image6_CH1))
        ...
        Layer6_1st_Iter_Image7_CH1_256 = (flip_lines_16(Layer6_1st_Iter_Image7_CH1))
        ...
        Layer6_1st_Iter_Image8_CH1_256 = (flip_lines_16(Layer6_1st_Iter_Image8_CH1))
        ...
        Layer7_1st_Iter_Image1_CH0_256 = (flip_lines_16(Layer7_1st_Iter_Image1_CH0))   
        ...
        Layer7_1st_Iter_Image2_CH0_256 = (flip_lines_16(Layer7_1st_Iter_Image2_CH0))
        ...
        Layer7_1st_Iter_Image3_CH0_256 = (flip_lines_16(Layer7_1st_Iter_Image3_CH0))
        ...
        Layer7_1st_Iter_Image4_CH0_256 = (flip_lines_16(Layer7_1st_Iter_Image4_CH0))
        ...
        Layer7_1st_Iter_Image5_CH0_256 = (flip_lines_16(Layer7_1st_Iter_Image5_CH0))
        ...
        Layer7_1st_Iter_Image6_CH0_256 = (flip_lines_16(Layer7_1st_Iter_Image6_CH0))
        ...
        Layer7_1st_Iter_Image7_CH0_256 = (flip_lines_16(Layer7_1st_Iter_Image7_CH0))
        ...
        Layer7_1st_Iter_Image8_CH0_256 = (flip_lines_16(Layer7_1st_Iter_Image8_CH0))
        ...
        Layer7_1st_Iter_Image1_CH1_256 = (flip_lines_16(Layer7_1st_Iter_Image1_CH1))
        ...
        Layer7_1st_Iter_Image2_CH1_256 = (flip_lines_16(Layer7_1st_Iter_Image2_CH1))
        ...
        Layer7_1st_Iter_Image3_CH1_256 = (flip_lines_16(Layer7_1st_Iter_Image3_CH1))
        ...
        Layer7_1st_Iter_Image4_CH1_256 = (flip_lines_16(Layer7_1st_Iter_Image4_CH1))
        ...
        Layer7_1st_Iter_Image5_CH1_256 = (flip_lines_16(Layer7_1st_Iter_Image5_CH1))
        ...
        Layer7_1st_Iter_Image6_CH1_256 = (flip_lines_16(Layer7_1st_Iter_Image6_CH1))
        ...
        Layer7_1st_Iter_Image7_CH1_256 = (flip_lines_16(Layer7_1st_Iter_Image7_CH1))
        ...
        Layer7_1st_Iter_Image8_CH1_256 = (flip_lines_16(Layer7_1st_Iter_Image8_CH1))
        ...
        if DEBUG2:
            Layer7_input_Image1_CH0 = Read_DDR(Rd_Address=0x86CB8000, End_Address=0x86CEC000)
            Layer7_input_Image1_CH0_256 = (flip_lines_16(Layer7_input_Image1_CH0))   
            #if DEBUG: print("ch0 image 1 : ", len(Layer7_input_Image1_CH0))     

            Layer7_input_Image2_CH0 = Read_DDR(Rd_Address=0x86CEC000, End_Address=0x86D20000)
            Layer7_input_Image2_CH0_256 = (flip_lines_16(Layer7_input_Image2_CH0))
            #if DEBUG: print("ch0 image 2 : ", len(Layer7_input_Image2_CH0))

            Layer7_input_Image3_CH0 = Read_DDR(Rd_Address=0x86D20000, End_Address=0x86D54000)
            Layer7_input_Image3_CH0_256 = (flip_lines_16(Layer7_input_Image3_CH0))
            #if DEBUG: print("ch0 image 3 : ", len(Layer7_input_Image3_CH0))

            Layer7_input_Image4_CH0 = Read_DDR(Rd_Address=0x86D54000, End_Address=0x86D88000)
            Layer7_input_Image4_CH0_256 = (flip_lines_16(Layer7_input_Image4_CH0))
            #if DEBUG: print("ch0 image 4 : ", len(Layer7_input_Image4_CH0))

            Layer7_input_Image5_CH0 = Read_DDR(Rd_Address=0x86D88000, End_Address=0x86DBC000)
            Layer7_input_Image5_CH0_256 = (flip_lines_16(Layer7_input_Image5_CH0))
            #if DEBUG: print("ch0 image 5 : ", len(Layer7_input_Image5_CH0))

            Layer7_input_Image6_CH0 = Read_DDR(Rd_Address=0x86DBC000, End_Address=0x86DF0000)
            Layer7_input_Image6_CH0_256 = (flip_lines_16(Layer7_input_Image6_CH0))
            #if DEBUG: print("ch0 image 6 : ", len(Layer7_input_Image6_CH0))

            Layer7_input_Image7_CH0 = Read_DDR(Rd_Address=0x86DF0000, End_Address=0x86E24000)
            Layer7_input_Image7_CH0_256 = (flip_lines_16(Layer7_input_Image7_CH0))
            #if DEBUG: print("ch0 image 7 : ", len(Layer7_input_Image7_CH0))

            Layer7_input_Image8_CH0 = Read_DDR(Rd_Address=0x86E24000, End_Address=0x86E58000)
            Layer7_input_Image8_CH0_256 = (flip_lines_16(Layer7_input_Image8_CH0))
            #if DEBUG: print("ch0 image 8 : ", len(Layer7_input_Image8_CH0))

            Layer7_input_Image1_CH1 = Read_DDR(Rd_Address=0x96CB8000, End_Address=0x96CEC000)
            Layer7_input_Image1_CH1_256 = (flip_lines_16(Layer7_input_Image1_CH1))   
            #if DEBUG: print("ch1 image 1 : ", len(Layer7_input_Image1_CH1))     

            Layer7_input_Image2_CH1 = Read_DDR(Rd_Address=0x96CEC000, End_Address=0x96D20000)
            Layer7_input_Image2_CH1_256 = (flip_lines_16(Layer7_input_Image2_CH1))
            #if DEBUG: print("ch1 image 2 : ", len(Layer7_input_Image2_CH1))

            Layer7_input_Image3_CH1 = Read_DDR(Rd_Address=0x96D20000, End_Address=0x96D54000)
            Layer7_input_Image3_CH1_256 = (flip_lines_16(Layer7_input_Image3_CH1))
            #if DEBUG: print("ch1 image 3 : ", len(Layer7_input_Image3_CH1))

            Layer7_input_Image4_CH1 = Read_DDR(Rd_Address=0x96D54000, End_Address=0x96D88000)
            Layer7_input_Image4_CH1_256 = (flip_lines_16(Layer7_input_Image4_CH1))
            #if DEBUG: print("ch1 image 4 : ", len(Layer7_input_Image4_CH1))

            Layer7_input_Image5_CH1 = Read_DDR(Rd_Address=0x96D88000, End_Address=0x96DBC000)
            Layer7_input_Image5_CH1_256 = (flip_lines_16(Layer7_input_Image5_CH1))
            #if DEBUG: print("ch1 image 5 : ", len(Layer7_input_Image5_CH1))

            Layer7_input_Image6_CH1 = Read_DDR(Rd_Address=0x96DBC000, End_Address=0x96DF0000)
            Layer7_input_Image6_CH1_256 = (flip_lines_16(Layer7_input_Image6_CH1))
            #if DEBUG: print("ch1 image 6 : ", len(Layer7_input_Image6_CH1))

            Layer7_input_Image7_CH1 = Read_DDR(Rd_Address=0x96DF0000, End_Address=0x96E24000)
            Layer7_input_Image7_CH1_256 = (flip_lines_16(Layer7_input_Image7_CH1))
            #if DEBUG: print("ch1 image 7 : ", len(Layer7_input_Image7_CH1))

            Layer7_input_Image8_CH1 = Read_DDR(Rd_Address=0x96E24000, End_Address=0x96E58000)
            Layer7_input_Image8_CH1_256 = (flip_lines_16(Layer7_input_Image8_CH1))
            #if DEBUG: print("ch1 image 8 : ", len(Layer7_input_Image8_CH1))
            e = time.time()
            if DEBUG: print("Read DDR & 32bit to 16bit : ",e-s)

            Input_Image1 = Read_OutFmap_Bfloat2Dec(Layer7_input_Image1_CH0_256, Layer7_input_Image1_CH1_256, Exponent_Bits, Mantissa_Bits, Out_CH=1024, Out_Size=13, Layer8=False)
            Input_Image2 = Read_OutFmap_Bfloat2Dec(Layer7_input_Image2_CH0_256, Layer7_input_Image2_CH1_256, Exponent_Bits, Mantissa_Bits, Out_CH=1024, Out_Size=13, Layer8=False)
            Input_Image3 = Read_OutFmap_Bfloat2Dec(Layer7_input_Image3_CH0_256, Layer7_input_Image3_CH1_256, Exponent_Bits, Mantissa_Bits, Out_CH=1024, Out_Size=13, Layer8=False)
            Input_Image4 = Read_OutFmap_Bfloat2Dec(Layer7_input_Image4_CH0_256, Layer7_input_Image4_CH1_256, Exponent_Bits, Mantissa_Bits, Out_CH=1024, Out_Size=13, Layer8=False)
            Input_Image5 = Read_OutFmap_Bfloat2Dec(Layer7_input_Image5_CH0_256, Layer7_input_Image5_CH1_256, Exponent_Bits, Mantissa_Bits, Out_CH=1024, Out_Size=13, Layer8=False)
            Input_Image6 = Read_OutFmap_Bfloat2Dec(Layer7_input_Image6_CH0_256, Layer7_input_Image6_CH1_256, Exponent_Bits, Mantissa_Bits, Out_CH=1024, Out_Size=13, Layer8=False)
            Input_Image7 = Read_OutFmap_Bfloat2Dec(Layer7_input_Image7_CH0_256, Layer7_input_Image7_CH1_256, Exponent_Bits, Mantissa_Bits, Out_CH=1024, Out_Size=13, Layer8=False)
            Input_Image8 = Read_OutFmap_Bfloat2Dec(Layer7_input_Image8_CH0_256, Layer7_input_Image8_CH1_256, Exponent_Bits, Mantissa_Bits, Out_CH=1024, Out_Size=13, Layer8=False)
            Input_Layer7 = Input_Image1 + Input_Image2 + Input_Image3 + Input_Image4 + \
                            Input_Image5 + Input_Image6 + Input_Image7 + Input_Image8   
            
            test_out = 'result/Input_Layer7.txt'
            with open(test_out, 'w+') as test_output:
                for item in Input_Layer7:
                    test_output.write(str(item) + "\n")
            test_output.close()                  
        ...
        Layer8_1st_Iter_Image1_CH0_256 = (flip_lines_16(Layer8_1st_Iter_Image1_CH0))   
        ...
        Layer8_1st_Iter_Image2_CH0_256 = (flip_lines_16(Layer8_1st_Iter_Image2_CH0))
        ...
        Layer8_1st_Iter_Image3_CH0_256 = (flip_lines_16(Layer8_1st_Iter_Image3_CH0))
        ...
        Layer8_1st_Iter_Image4_CH0_256 = (flip_lines_16(Layer8_1st_Iter_Image4_CH0))
        ...
        Layer8_1st_Iter_Image5_CH0_256 = (flip_lines_16(Layer8_1st_Iter_Image5_CH0))
        ...
        Layer8_1st_Iter_Image6_CH0_256 = (flip_lines_16(Layer8_1st_Iter_Image6_CH0))
        ...
        Layer8_1st_Iter_Image7_CH0_256 = (flip_lines_16(Layer8_1st_Iter_Image7_CH0))
        ...
        Layer8_1st_Iter_Image8_CH0_256 = (flip_lines_16(Layer8_1st_Iter_Image8_CH0))
        ...
        Layer8_1st_Iter_Image1_CH1_256 = (flip_lines_16(Layer8_1st_Iter_Image1_CH1))   
        ...
        Layer8_1st_Iter_Image2_CH1_256 = (flip_lines_16(Layer8_1st_Iter_Image2_CH1))
        ...
        Layer8_1st_Iter_Image3_CH1_256 = (flip_lines_16(Layer8_1st_Iter_Image3_CH1))
        ...
        Layer8_1st_Iter_Image4_CH1_256 = (flip_lines_16(Layer8_1st_Iter_Image4_CH1))
        ...
        Layer8_1st_Iter_Image5_CH1_256 = (flip_lines_16(Layer8_1st_Iter_Image5_CH1))
        ...
        Layer8_1st_Iter_Image6_CH1_256 = (flip_lines_16(Layer8_1st_Iter_Image6_CH1))
        ...
        Layer8_1st_Iter_Image7_CH1_256 = (flip_lines_16(Layer8_1st_Iter_Image7_CH1))
        ...
        Layer8_1st_Iter_Image8_CH1_256 = (flip_lines_16(Layer8_1st_Iter_Image8_CH1))
        ...
        if DEBUG2:
            Layer8_input_Image1_CH0 = Read_DDR(Rd_Address=0x86FF8000, End_Address=0x8702C000)
            Layer8_input_Image1_CH0_256 = (flip_lines_16(Layer8_input_Image1_CH0))   
            #if DEBUG: print("ch0 image 1 : ", len(Layer8_input_Image1_CH0))     

            Layer8_input_Image2_CH0 = Read_DDR(Rd_Address=0x8702C000, End_Address=0x87060000)
            Layer8_input_Image2_CH0_256 = (flip_lines_16(Layer8_input_Image2_CH0))
            #if DEBUG: print("ch0 image 2 : ", len(Layer8_input_Image2_CH0))

            Layer8_input_Image3_CH0 = Read_DDR(Rd_Address=0x87060000, End_Address=0x87094000)
            Layer8_input_Image3_CH0_256 = (flip_lines_16(Layer8_input_Image3_CH0))
            #if DEBUG: print("ch0 image 3 : ", len(Layer8_input_Image3_CH0))

            Layer8_input_Image4_CH0 = Read_DDR(Rd_Address=0x87094000, End_Address=0x870C8000)
            Layer8_input_Image4_CH0_256 = (flip_lines_16(Layer8_input_Image4_CH0))
            #if DEBUG: print("ch0 image 4 : ", len(Layer8_input_Image4_CH0))

            Layer8_input_Image5_CH0 = Read_DDR(Rd_Address=0x870C8000, End_Address=0x870FC000)
            Layer8_input_Image5_CH0_256 = (flip_lines_16(Layer8_input_Image5_CH0))
            #if DEBUG: print("ch0 image 5 : ", len(Layer8_input_Image5_CH0))

            Layer8_input_Image6_CH0 = Read_DDR(Rd_Address=0x870FC000, End_Address=0x87130000)
            Layer8_input_Image6_CH0_256 = (flip_lines_16(Layer8_input_Image6_CH0))
            #if DEBUG: print("ch0 image 6 : ", len(Layer8_input_Image6_CH0))

            Layer8_input_Image7_CH0 = Read_DDR(Rd_Address=0x87130000, End_Address=0x87164000)
            Layer8_input_Image7_CH0_256 = (flip_lines_16(Layer8_input_Image7_CH0))
            #if DEBUG: print("ch0 image 7 : ", len(Layer8_input_Image7_CH0))

            Layer8_input_Image8_CH0 = Read_DDR(Rd_Address=0x87164000, End_Address=0x87198000)
            Layer8_input_Image8_CH0_256 = (flip_lines_16(Layer8_input_Image8_CH0))
            #if DEBUG: print("ch0 image 8 : ", len(Layer8_input_Image8_CH0))

            Layer8_input_Image1_CH1 = Read_DDR(Rd_Address=0x96FF8000, End_Address=0x9702C000)
            Layer8_input_Image1_CH1_256 = (flip_lines_16(Layer8_input_Image1_CH1))   
            #if DEBUG: print("ch1 image 1 : ", len(Layer8_input_Image1_CH1))     

            Layer8_input_Image2_CH1 = Read_DDR(Rd_Address=0x9702C000, End_Address=0x97060000)
            Layer8_input_Image2_CH1_256 = (flip_lines_16(Layer8_input_Image2_CH1))
            #if DEBUG: print("ch1 image 2 : ", len(Layer8_input_Image2_CH1))

            Layer8_input_Image3_CH1 = Read_DDR(Rd_Address=0x97060000, End_Address=0x97094000)
            Layer8_input_Image3_CH1_256 = (flip_lines_16(Layer8_input_Image3_CH1))
            #if DEBUG: print("ch1 image 3 : ", len(Layer8_input_Image3_CH1))

            Layer8_input_Image4_CH1 = Read_DDR(Rd_Address=0x97094000, End_Address=0x970C8000)
            Layer8_input_Image4_CH1_256 = (flip_lines_16(Layer8_input_Image4_CH1))
            #if DEBUG: print("ch1 image 4 : ", len(Layer8_input_Image4_CH1))

            Layer8_input_Image5_CH1 = Read_DDR(Rd_Address=0x970C8000, End_Address=0x970FC000)
            Layer8_input_Image5_CH1_256 = (flip_lines_16(Layer8_input_Image5_CH1))
            #if DEBUG: print("ch1 image 5 : ", len(Layer8_input_Image5_CH1))

            Layer8_input_Image6_CH1 = Read_DDR(Rd_Address=0x970FC000, End_Address=0x97130000)
            Layer8_input_Image6_CH1_256 = (flip_lines_16(Layer8_input_Image6_CH1))
            #if DEBUG: print("ch1 image 6 : ", len(Layer8_input_Image6_CH1))

            Layer8_input_Image7_CH1 = Read_DDR(Rd_Address=0x97130000, End_Address=0x97164000)
            Layer8_input_Image7_CH1_256 = (flip_lines_16(Layer8_input_Image7_CH1))
            #if DEBUG: print("ch1 image 7 : ", len(Layer8_input_Image7_CH1))

            Layer8_input_Image8_CH1 = Read_DDR(Rd_Address=0x97164000, End_Address=0x97198000)
            Layer8_input_Image8_CH1_256 = (flip_lines_16(Layer8_input_Image8_CH1))
            #if DEBUG: print("ch1 image 8 : ", len(Layer8_input_Image8_CH1))
            e = time.time()
            if DEBUG: print("Read DDR & 32bit to 16bit : ",e-s)

            Input_Image1 = Read_OutFmap_Bfloat2Dec(Layer8_input_Image1_CH0_256, Layer8_input_Image1_CH1_256, Exponent_Bits, Mantissa_Bits, Out_CH=1024, Out_Size=13, Layer8=False)
            Input_Image2 = Read_OutFmap_Bfloat2Dec(Layer8_input_Image2_CH0_256, Layer8_input_Image2_CH1_256, Exponent_Bits, Mantissa_Bits, Out_CH=1024, Out_Size=13, Layer8=False)
            Input_Image3 = Read_OutFmap_Bfloat2Dec(Layer8_input_Image3_CH0_256, Layer8_input_Image3_CH1_256, Exponent_Bits, Mantissa_Bits, Out_CH=1024, Out_Size=13, Layer8=False)
            Input_Image4 = Read_OutFmap_Bfloat2Dec(Layer8_input_Image4_CH0_256, Layer8_input_Image4_CH1_256, Exponent_Bits, Mantissa_Bits, Out_CH=1024, Out_Size=13, Layer8=False)
            Input_Image5 = Read_OutFmap_Bfloat2Dec(Layer8_input_Image5_CH0_256, Layer8_input_Image5_CH1_256, Exponent_Bits, Mantissa_Bits, Out_CH=1024, Out_Size=13, Layer8=False)
            Input_Image6 = Read_OutFmap_Bfloat2Dec(Layer8_input_Image6_CH0_256, Layer8_input_Image6_CH1_256, Exponent_Bits, Mantissa_Bits, Out_CH=1024, Out_Size=13, Layer8=False)
            Input_Image7 = Read_OutFmap_Bfloat2Dec(Layer8_input_Image7_CH0_256, Layer8_input_Image7_CH1_256, Exponent_Bits, Mantissa_Bits, Out_CH=1024, Out_Size=13, Layer8=False)
            Input_Image8 = Read_OutFmap_Bfloat2Dec(Layer8_input_Image8_CH0_256, Layer8_input_Image8_CH1_256, Exponent_Bits, Mantissa_Bits, Out_CH=1024, Out_Size=13, Layer8=False)
            Input_Layer8 = Input_Image1 + Input_Image2 + Input_Image3 + Input_Image4 + \
                            Input_Image5 + Input_Image6 + Input_Image7 + Input_Image8   
            
            test_out = 'result/Input_Layer8.txt'
            with open(test_out, 'w+') as test_output:
                for item in Input_Layer8:
                    test_output.write(str(item) + "\n")
            test_output.close()                  
    ...
    def Backward(self, data, Loss_Gradient):
        ...
        s = time.time()
        ReLu_Marking1_Layer7_CH0 = Read_DDR0(Rd_Address=0x880D4000,  End_Address=0x88108000)
        ReLu_Marking1_Layer7_CH0_256 = data_32_to_16(ReLu_Marking1_Layer7_CH0)

        ReLu_Marking2_Layer7_CH0 = Read_DDR0(Rd_Address=0x88108000,  End_Address=0x8813C000)
        ReLu_Marking2_Layer7_CH0_256 = data_32_to_16(ReLu_Marking2_Layer7_CH0)

        ReLu_Marking3_Layer7_CH0 = Read_DDR0(Rd_Address=0x8813C000,  End_Address=0x88170000)
        ReLu_Marking3_Layer7_CH0_256 = data_32_to_16(ReLu_Marking3_Layer7_CH0)

        ReLu_Marking4_Layer7_CH0 = Read_DDR0(Rd_Address=0x88170000,  End_Address=0x881A4000)
        ReLu_Marking4_Layer7_CH0_256 = data_32_to_16(ReLu_Marking4_Layer7_CH0)

        ReLu_Marking5_Layer7_CH0 = Read_DDR0(Rd_Address=0x881A4000,  End_Address=0x881D8000)
        ReLu_Marking5_Layer7_CH0_256 = data_32_to_16(ReLu_Marking5_Layer7_CH0)

        ReLu_Marking6_Layer7_CH0 = Read_DDR0(Rd_Address=0x881D8000,  End_Address=0x8820C000)
        ReLu_Marking6_Layer7_CH0_256 = data_32_to_16(ReLu_Marking6_Layer7_CH0)

        ReLu_Marking7_Layer7_CH0 = Read_DDR0(Rd_Address=0x8820C000,  End_Address=0x88240000)
        ReLu_Marking7_Layer7_CH0_256 = data_32_to_16(ReLu_Marking7_Layer7_CH0)

        ReLu_Marking8_Layer7_CH0 = Read_DDR0(Rd_Address=0x88240000,  End_Address=0x88274000)
        ReLu_Marking8_Layer7_CH0_256 = data_32_to_16(ReLu_Marking8_Layer7_CH0)

        ReLu_Marking1_Layer7_CH1 = Read_DDR0(Rd_Address=0x980D4000,  End_Address=0x98108000)
        ReLu_Marking1_Layer7_CH1_256 = data_32_to_16(ReLu_Marking1_Layer7_CH1)

        ReLu_Marking2_Layer7_CH1 = Read_DDR0(Rd_Address=0x98108000,  End_Address=0x9813C000)
        ReLu_Marking2_Layer7_CH1_256 = data_32_to_16(ReLu_Marking2_Layer7_CH1)

        ReLu_Marking3_Layer7_CH1 = Read_DDR0(Rd_Address=0x9813C000,  End_Address=0x98170000)
        ReLu_Marking3_Layer7_CH1_256 = data_32_to_16(ReLu_Marking3_Layer7_CH1)

        ReLu_Marking4_Layer7_CH1 = Read_DDR0(Rd_Address=0x98170000,  End_Address=0x981A4000)
        ReLu_Marking4_Layer7_CH1_256 = data_32_to_16(ReLu_Marking4_Layer7_CH1)

        ReLu_Marking5_Layer7_CH1 = Read_DDR0(Rd_Address=0x981A4000,  End_Address=0x981D8000)
        ReLu_Marking5_Layer7_CH1_256 = data_32_to_16(ReLu_Marking5_Layer7_CH1)

        ReLu_Marking6_Layer7_CH1 = Read_DDR0(Rd_Address=0x981D8000,  End_Address=0x9820C000)
        ReLu_Marking6_Layer7_CH1_256 = data_32_to_16(ReLu_Marking6_Layer7_CH1)

        ReLu_Marking7_Layer7_CH1 = Read_DDR0(Rd_Address=0x9820C000,  End_Address=0x98240000)
        ReLu_Marking7_Layer7_CH1_256 = data_32_to_16(ReLu_Marking7_Layer7_CH1)

        ReLu_Marking8_Layer7_CH1 = Read_DDR0(Rd_Address=0x98240000,  End_Address=0x98274000)
        ...
        Weight_Gradient1_Layer8_CH0_256 = flip_lines_16(Weight_Gradient1_Layer8_CH0)
        ...
        Weight_Gradient2_Layer8_CH0_256 = flip_lines_16(Weight_Gradient2_Layer8_CH0)
        ...
        Weight_Gradient3_Layer8_CH0_256 = flip_lines_16(Weight_Gradient3_Layer8_CH0)
        ...
        Weight_Gradient4_Layer8_CH0_256 = flip_lines_16(Weight_Gradient4_Layer8_CH0)
        ...
        Weight_Gradient5_Layer8_CH0_256 = flip_lines_16(Weight_Gradient5_Layer8_CH0)
        ...
        Weight_Gradient6_Layer8_CH0_256 = flip_lines_16(Weight_Gradient6_Layer8_CH0)
        ...
        Weight_Gradient7_Layer8_CH0_256 = flip_lines_16(Weight_Gradient7_Layer8_CH0)
        ...
        Weight_Gradient8_Layer8_CH0_256 = flip_lines_16(Weight_Gradient8_Layer8_CH0)
        ...
        Weight_Gradient1_Layer8_CH1_256 = flip_lines_16(Weight_Gradient1_Layer8_CH1)
        ...
        Weight_Gradient2_Layer8_CH1_256 = flip_lines_16(Weight_Gradient2_Layer8_CH1)
        ...
        Weight_Gradient3_Layer8_CH1_256 = flip_lines_16(Weight_Gradient3_Layer8_CH1)
        ...
        Weight_Gradient4_Layer8_CH1_256 = flip_lines_16(Weight_Gradient4_Layer8_CH1)
        ...
        Weight_Gradient5_Layer8_CH1_256 = flip_lines_16(Weight_Gradient5_Layer8_CH1)
        ...
        Weight_Gradient6_Layer8_CH1_256 = flip_lines_16(Weight_Gradient6_Layer8_CH1)
        ...
        Weight_Gradient7_Layer8_CH1_256 = flip_lines_16(Weight_Gradient7_Layer8_CH1)
        ...
        Weight_Gradient8_Layer8_CH1_256 = flip_lines_16(Weight_Gradient8_Layer8_CH1)
        ...
        # BReLu Marking
        s = time.time()
        ReLu_Marking1_Layer6_CH0 = Read_DDR0(Rd_Address=0x87F34000,  End_Address=0x87F68000)
        ReLu_Marking1_Layer6_CH0_256 = data_32_to_16(ReLu_Marking1_Layer6_CH0)

        ReLu_Marking2_Layer6_CH0 = Read_DDR0(Rd_Address=0x87F68000,  End_Address=0x87F9C000)
        ReLu_Marking2_Layer6_CH0_256 = data_32_to_16(ReLu_Marking2_Layer6_CH0)

        ReLu_Marking3_Layer6_CH0 = Read_DDR0(Rd_Address=0x87F9C000,  End_Address=0x87FD0000)
        ReLu_Marking3_Layer6_CH0_256 = data_32_to_16(ReLu_Marking3_Layer6_CH0)

        ReLu_Marking4_Layer6_CH0 = Read_DDR0(Rd_Address=0x87FD0000,  End_Address=0x88004000)
        ReLu_Marking4_Layer6_CH0_256 = data_32_to_16(ReLu_Marking4_Layer6_CH0)

        ReLu_Marking5_Layer6_CH0 = Read_DDR0(Rd_Address=0x88004000,  End_Address=0x88038000)
        ReLu_Marking5_Layer6_CH0_256 = data_32_to_16(ReLu_Marking5_Layer6_CH0)

        ReLu_Marking6_Layer6_CH0 = Read_DDR0(Rd_Address=0x88038000,  End_Address=0x8806C000)
        ReLu_Marking6_Layer6_CH0_256 = data_32_to_16(ReLu_Marking6_Layer6_CH0)

        ReLu_Marking7_Layer6_CH0 = Read_DDR0(Rd_Address=0x8806C000,  End_Address=0x880A0000)
        ReLu_Marking7_Layer6_CH0_256 = data_32_to_16(ReLu_Marking7_Layer6_CH0)

        ReLu_Marking8_Layer6_CH0 = Read_DDR0(Rd_Address=0x880A0000,  End_Address=0x880D4000)
        ReLu_Marking8_Layer6_CH0_256 = data_32_to_16(ReLu_Marking8_Layer6_CH0)

        ReLu_Marking1_Layer6_CH1 = Read_DDR0(Rd_Address=0x97F34000,  End_Address=0x97F68000)
        ReLu_Marking1_Layer6_CH1_256 = data_32_to_16(ReLu_Marking1_Layer6_CH1)

        ReLu_Marking2_Layer6_CH1 = Read_DDR0(Rd_Address=0x97F68000,  End_Address=0x97F9C000)
        ReLu_Marking2_Layer6_CH1_256 = data_32_to_16(ReLu_Marking2_Layer6_CH1)

        ReLu_Marking3_Layer6_CH1 = Read_DDR0(Rd_Address=0x97F9C000,  End_Address=0x97FD0000)
        ReLu_Marking3_Layer6_CH1_256 = data_32_to_16(ReLu_Marking3_Layer6_CH1)

        ReLu_Marking4_Layer6_CH1 = Read_DDR0(Rd_Address=0x97FD0000,  End_Address=0x98004000)
        ReLu_Marking4_Layer6_CH1_256 = data_32_to_16(ReLu_Marking4_Layer6_CH1)

        ReLu_Marking5_Layer6_CH1 = Read_DDR0(Rd_Address=0x98004000,  End_Address=0x98038000)
        ReLu_Marking5_Layer6_CH1_256 = data_32_to_16(ReLu_Marking5_Layer6_CH1)

        ReLu_Marking6_Layer6_CH1 = Read_DDR0(Rd_Address=0x98038000,  End_Address=0x9806C000)
        ReLu_Marking6_Layer6_CH1_256 = data_32_to_16(ReLu_Marking6_Layer6_CH1)

        ReLu_Marking7_Layer6_CH1 = Read_DDR0(Rd_Address=0x9806C000,  End_Address=0x980A0000)
        ReLu_Marking7_Layer6_CH1_256 = data_32_to_16(ReLu_Marking7_Layer6_CH1)

        ReLu_Marking8_Layer6_CH1 = Read_DDR0(Rd_Address=0x980A0000,  End_Address=0x980D4000)
        ...
        Weight_Gradient1_Layer7_CH0_256 = flip_lines_16(Weight_Gradient1_Layer7_CH0)
        ...
        Weight_Gradient2_Layer7_CH0_256 = flip_lines_16(Weight_Gradient2_Layer7_CH0)
        ...
        Weight_Gradient3_Layer7_CH0_256 = flip_lines_16(Weight_Gradient3_Layer7_CH0)
        ...
        Weight_Gradient4_Layer7_CH0_256 = flip_lines_16(Weight_Gradient4_Layer7_CH0)
        ...
        Weight_Gradient5_Layer7_CH0_256 = flip_lines_16(Weight_Gradient5_Layer7_CH0)
        ...
        Weight_Gradient6_Layer7_CH0_256 = flip_lines_16(Weight_Gradient6_Layer7_CH0)
        ...
        Weight_Gradient7_Layer7_CH0_256 = flip_lines_16(Weight_Gradient7_Layer7_CH0)
        ...
        Weight_Gradient8_Layer7_CH0_256 = flip_lines_16(Weight_Gradient8_Layer7_CH0)
        ...
        Weight_Gradient1_Layer7_CH1_256 = flip_lines_16(Weight_Gradient1_Layer7_CH1)
        ...
        Weight_Gradient2_Layer7_CH1_256 = flip_lines_16(Weight_Gradient2_Layer7_CH1)
        ...
        Weight_Gradient3_Layer7_CH1_256 = flip_lines_16(Weight_Gradient3_Layer7_CH1)
        ...
        Weight_Gradient4_Layer7_CH1_256 = flip_lines_16(Weight_Gradient4_Layer7_CH1)
        ...
        Weight_Gradient5_Layer7_CH1_256 = flip_lines_16(Weight_Gradient5_Layer7_CH1)
        ...
        Weight_Gradient6_Layer7_CH1_256 = flip_lines_16(Weight_Gradient6_Layer7_CH1)
        ...
        Weight_Gradient7_Layer7_CH1_256 = flip_lines_16(Weight_Gradient7_Layer7_CH1)
        ...
        Weight_Gradient8_Layer7_CH1_256 = flip_lines_16(Weight_Gradient8_Layer7_CH1)
        ...
        # BReLu Marking
        s = time.time()
        ReLu_Marking1_Layer5_CH0 = Read_DDR0(Rd_Address=0x87E64000,  End_Address=0x87E7E000)
        ReLu_Marking1_Layer5_CH0_256 = data_32_to_16(ReLu_Marking1_Layer5_CH0)

        ReLu_Marking2_Layer5_CH0 = Read_DDR0(Rd_Address=0x87E7E000,  End_Address=0x87E98000)
        ReLu_Marking2_Layer5_CH0_256 = data_32_to_16(ReLu_Marking2_Layer5_CH0)

        ReLu_Marking3_Layer5_CH0 = Read_DDR0(Rd_Address=0x87E98000,  End_Address=0x87EB2000)
        ReLu_Marking3_Layer5_CH0_256 = data_32_to_16(ReLu_Marking3_Layer5_CH0)

        ReLu_Marking4_Layer5_CH0 = Read_DDR0(Rd_Address=0x87EB2000,  End_Address=0x87ECC000)
        ReLu_Marking4_Layer5_CH0_256 = data_32_to_16(ReLu_Marking4_Layer5_CH0)

        ReLu_Marking5_Layer5_CH0 = Read_DDR0(Rd_Address=0x87ECC000,  End_Address=0x87EE6000)
        ReLu_Marking5_Layer5_CH0_256 = data_32_to_16(ReLu_Marking5_Layer5_CH0)

        ReLu_Marking6_Layer5_CH0 = Read_DDR0(Rd_Address=0x87EE6000,  End_Address=0x87F00000)
        ReLu_Marking6_Layer5_CH0_256 = data_32_to_16(ReLu_Marking6_Layer5_CH0)

        ReLu_Marking7_Layer5_CH0 = Read_DDR0(Rd_Address=0x87F00000,  End_Address=0x87F1A000)
        ReLu_Marking7_Layer5_CH0_256 = data_32_to_16(ReLu_Marking7_Layer5_CH0)

        ReLu_Marking8_Layer5_CH0 = Read_DDR0(Rd_Address=0x87F1A000,  End_Address=0x87F34000)
        ReLu_Marking8_Layer5_CH0_256 = data_32_to_16(ReLu_Marking8_Layer5_CH0)

        ReLu_Marking1_Layer5_CH1 = Read_DDR0(Rd_Address=0x97E64000,  End_Address=0x97E7E000)
        ReLu_Marking1_Layer5_CH1_256 = data_32_to_16(ReLu_Marking1_Layer5_CH1)

        ReLu_Marking2_Layer5_CH1 = Read_DDR0(Rd_Address=0x97E7E000,  End_Address=0x97E98000)
        ReLu_Marking2_Layer5_CH1_256 = data_32_to_16(ReLu_Marking2_Layer5_CH1)

        ReLu_Marking3_Layer5_CH1 = Read_DDR0(Rd_Address=0x97E98000,  End_Address=0x97EB2000)
        ReLu_Marking3_Layer5_CH1_256 = data_32_to_16(ReLu_Marking3_Layer5_CH1)

        ReLu_Marking4_Layer5_CH1 = Read_DDR0(Rd_Address=0x97EB2000,  End_Address=0x97ECC000)
        ReLu_Marking4_Layer5_CH1_256 = data_32_to_16(ReLu_Marking4_Layer5_CH1)

        ReLu_Marking5_Layer5_CH1 = Read_DDR0(Rd_Address=0x97ECC000,  End_Address=0x97EE6000)
        ReLu_Marking5_Layer5_CH1_256 = data_32_to_16(ReLu_Marking5_Layer5_CH1)

        ReLu_Marking6_Layer5_CH1 = Read_DDR0(Rd_Address=0x97EE6000,  End_Address=0x97F00000)
        ReLu_Marking6_Layer5_CH1_256 = data_32_to_16(ReLu_Marking6_Layer5_CH1)

        ReLu_Marking7_Layer5_CH1 = Read_DDR0(Rd_Address=0x97F00000,  End_Address=0x97F1A000)
        ReLu_Marking7_Layer5_CH1_256 = data_32_to_16(ReLu_Marking7_Layer5_CH1)

        ReLu_Marking8_Layer5_CH1 = Read_DDR0(Rd_Address=0x97F1A000,  End_Address=0x97F34000)
        ...
        Weight_Gradient1_Layer6_CH0_256 = flip_lines_16(Weight_Gradient1_Layer6_CH0)
        ...
        Weight_Gradient2_Layer6_CH0_256 = flip_lines_16(Weight_Gradient2_Layer6_CH0)
        ...
        Weight_Gradient3_Layer6_CH0_256 = flip_lines_16(Weight_Gradient3_Layer6_CH0)
        ...
        Weight_Gradient4_Layer6_CH0_256 = flip_lines_16(Weight_Gradient4_Layer6_CH0)
        ...
        Weight_Gradient5_Layer6_CH0_256 = flip_lines_16(Weight_Gradient5_Layer6_CH0)
        ...
        Weight_Gradient6_Layer6_CH0_256 = flip_lines_16(Weight_Gradient6_Layer6_CH0)
        ...
        Weight_Gradient7_Layer6_CH0_256 = flip_lines_16(Weight_Gradient7_Layer6_CH0)
        ...
        Weight_Gradient8_Layer6_CH0_256 = flip_lines_16(Weight_Gradient8_Layer6_CH0)
        ...
        Weight_Gradient1_Layer6_CH1_256 = flip_lines_16(Weight_Gradient1_Layer6_CH1)
        ...
        Weight_Gradient2_Layer6_CH1_256 = flip_lines_16(Weight_Gradient2_Layer6_CH1)
        ...
        Weight_Gradient3_Layer6_CH1_256 = flip_lines_16(Weight_Gradient3_Layer6_CH1)
        ...
        Weight_Gradient4_Layer6_CH1_256 = flip_lines_16(Weight_Gradient4_Layer6_CH1)
        ...
        Weight_Gradient5_Layer6_CH1_256 = flip_lines_16(Weight_Gradient5_Layer6_CH1)
        ...
        Weight_Gradient6_Layer6_CH1_256 = flip_lines_16(Weight_Gradient6_Layer6_CH1)
        ...
        Weight_Gradient7_Layer6_CH1_256 = flip_lines_16(Weight_Gradient7_Layer6_CH1)
        ...
        Weight_Gradient8_Layer6_CH1_256 = flip_lines_16(Weight_Gradient8_Layer6_CH1)
        ...
        Output_Grad1_Layer5_CH0_16 = flip_lines_16(Output_Grad1_Layer5_CH0_)
        ...
        Output_Grad1_Layer5_CH1_16 = flip_lines_16(Output_Grad1_Layer5_CH1_)
        ...
        Output_Grad2_Layer5_CH0_16 = flip_lines_16(Output_Grad2_Layer5_CH0_)
        ...
        Output_Grad2_Layer5_CH1_16 = flip_lines_16(Output_Grad2_Layer5_CH1_)
        ...
        Output_Grad3_Layer5_CH0_16 = flip_lines_16(Output_Grad3_Layer5_CH0_)
        ...
        Output_Grad3_Layer5_CH1_16 = flip_lines_16(Output_Grad3_Layer5_CH1_)
        ...
        Output_Grad4_Layer5_CH0_16 = flip_lines_16(Output_Grad4_Layer5_CH0_)
        ...
        Output_Grad4_Layer5_CH1_16 = flip_lines_16(Output_Grad4_Layer5_CH1_)
        ...
        Output_Grad5_Layer5_CH0_16 = flip_lines_16(Output_Grad5_Layer5_CH0_)
        ...
        Output_Grad5_Layer5_CH1_16 = flip_lines_16(Output_Grad5_Layer5_CH1_)
        ...
        Output_Grad6_Layer5_CH0_16 = flip_lines_16(Output_Grad6_Layer5_CH0_)
        ...
        Output_Grad6_Layer5_CH1_16 = flip_lines_16(Output_Grad6_Layer5_CH1_)
        ...
        Output_Grad7_Layer5_CH0_16 = flip_lines_16(Output_Grad7_Layer5_CH0_)
        ...
        Output_Grad7_Layer5_CH1_16 = flip_lines_16(Output_Grad7_Layer5_CH1_)
        ...
        Output_Grad8_Layer5_CH0_16 = flip_lines_16(Output_Grad8_Layer5_CH0_)
        ...
        Output_Grad8_Layer5_CH1_16 = flip_lines_16(Output_Grad8_Layer5_CH1_)
        ...
        # ReLU
        s = time.time()
        ReLu_Marking1_Layer4_CH0 = Read_DDR0(Rd_Address=0x87DFC000,  End_Address=0x87E09000)
        ReLu_Marking1_Layer4_CH0_256 = data_32_to_16(ReLu_Marking1_Layer4_CH0)

        ReLu_Marking2_Layer4_CH0 = Read_DDR0(Rd_Address=0x87E09000,  End_Address=0x87E16000)
        ReLu_Marking2_Layer4_CH0_256 = data_32_to_16(ReLu_Marking2_Layer4_CH0)

        ReLu_Marking3_Layer4_CH0 = Read_DDR0(Rd_Address=0x87E16000,  End_Address=0x87E23000)
        ReLu_Marking3_Layer4_CH0_256 = data_32_to_16(ReLu_Marking3_Layer4_CH0)

        ReLu_Marking4_Layer4_CH0 = Read_DDR0(Rd_Address=0x87E23000,  End_Address=0x87E30000)
        ReLu_Marking4_Layer4_CH0_256 = data_32_to_16(ReLu_Marking4_Layer4_CH0)

        ReLu_Marking5_Layer4_CH0 = Read_DDR0(Rd_Address=0x87E30000,  End_Address=0x87E3D000)
        ReLu_Marking5_Layer4_CH0_256 = data_32_to_16(ReLu_Marking5_Layer4_CH0)

        ReLu_Marking6_Layer4_CH0 = Read_DDR0(Rd_Address=0x87E3D000,  End_Address=0x87E4A000)
        ReLu_Marking6_Layer4_CH0_256 = data_32_to_16(ReLu_Marking6_Layer4_CH0)

        ReLu_Marking7_Layer4_CH0 = Read_DDR0(Rd_Address=0x87E4A000,  End_Address=0x87E57000)
        ReLu_Marking7_Layer4_CH0_256 = data_32_to_16(ReLu_Marking7_Layer4_CH0)

        ReLu_Marking8_Layer4_CH0 = Read_DDR0(Rd_Address=0x87E57000,  End_Address=0x87E64000)
        ReLu_Marking8_Layer4_CH0_256 = data_32_to_16(ReLu_Marking8_Layer4_CH0)

        ReLu_Marking1_Layer4_CH1 = Read_DDR0(Rd_Address=0x97DFC000,  End_Address=0x97E09000)
        ReLu_Marking1_Layer4_CH1_256 = data_32_to_16(ReLu_Marking1_Layer4_CH1)

        ReLu_Marking2_Layer4_CH1 = Read_DDR0(Rd_Address=0x97E09000,  End_Address=0x97E16000)
        ReLu_Marking2_Layer4_CH1_256 = data_32_to_16(ReLu_Marking2_Layer4_CH1)

        ReLu_Marking3_Layer4_CH1 = Read_DDR0(Rd_Address=0x97E16000,  End_Address=0x97E23000)
        ReLu_Marking3_Layer4_CH1_256 = data_32_to_16(ReLu_Marking3_Layer4_CH1)

        ReLu_Marking4_Layer4_CH1 = Read_DDR0(Rd_Address=0x97E23000,  End_Address=0x97E30000)
        ReLu_Marking4_Layer4_CH1_256 = data_32_to_16(ReLu_Marking4_Layer4_CH1)

        ReLu_Marking5_Layer4_CH1 = Read_DDR0(Rd_Address=0x97E30000,  End_Address=0x97E3D000)
        ReLu_Marking5_Layer4_CH1_256 = data_32_to_16(ReLu_Marking5_Layer4_CH1)

        ReLu_Marking6_Layer4_CH1 = Read_DDR0(Rd_Address=0x97E3D000,  End_Address=0x97E4A000)
        ReLu_Marking6_Layer4_CH1_256 = data_32_to_16(ReLu_Marking6_Layer4_CH1)

        ReLu_Marking7_Layer4_CH1 = Read_DDR0(Rd_Address=0x97E4A000,  End_Address=0x97E57000)
        ReLu_Marking7_Layer4_CH1_256 = data_32_to_16(ReLu_Marking7_Layer4_CH1)

        ReLu_Marking8_Layer4_CH1 = Read_DDR0(Rd_Address=0x97E57000,  End_Address=0x97E64000)
        ...
        Weight_Gradient1_Layer5_CH0_256 = flip_lines_16(Weight_Gradient1_Layer5_CH0)
        ...
        Weight_Gradient2_Layer5_CH0_256 = flip_lines_16(Weight_Gradient2_Layer5_CH0)
        ...
        Weight_Gradient3_Layer5_CH0_256 = flip_lines_16(Weight_Gradient3_Layer5_CH0)
        ...
        Weight_Gradient4_Layer5_CH0_256 = flip_lines_16(Weight_Gradient4_Layer5_CH0)
        ...
        Weight_Gradient5_Layer5_CH0_256 = flip_lines_16(Weight_Gradient5_Layer5_CH0)
        ...
        Weight_Gradient6_Layer5_CH0_256 = flip_lines_16(Weight_Gradient6_Layer5_CH0)
        ...
        Weight_Gradient7_Layer5_CH0_256 = flip_lines_16(Weight_Gradient7_Layer5_CH0)
        ...
        Weight_Gradient8_Layer5_CH0_256 = flip_lines_16(Weight_Gradient8_Layer5_CH0)
        ...
        Weight_Gradient1_Layer5_CH1_256 = flip_lines_16(Weight_Gradient1_Layer5_CH1)
        ...
        Weight_Gradient2_Layer5_CH1_256 = flip_lines_16(Weight_Gradient2_Layer5_CH1)
        ...
        Weight_Gradient3_Layer5_CH1_256 = flip_lines_16(Weight_Gradient3_Layer5_CH1)
        ...
        Weight_Gradient4_Layer5_CH1_256 = flip_lines_16(Weight_Gradient4_Layer5_CH1)
        ...
        Weight_Gradient5_Layer5_CH1_256 = flip_lines_16(Weight_Gradient5_Layer5_CH1)
        ...
        Weight_Gradient6_Layer5_CH1_256 = flip_lines_16(Weight_Gradient6_Layer5_CH1)
        ...
        Weight_Gradient7_Layer5_CH1_256 = flip_lines_16(Weight_Gradient7_Layer5_CH1)
        ...
        Weight_Gradient8_Layer5_CH1_256 = flip_lines_16(Weight_Gradient8_Layer5_CH1)
        ...
        Output_Grad1_Layer4_CH0_16 = flip_lines_16(Output_Grad1_Layer4_CH0_)
        ...
        Output_Grad1_Layer4_CH1_16 = flip_lines_16(Output_Grad1_Layer4_CH1_)
        ...
        Output_Grad2_Layer4_CH0_16 = flip_lines_16(Output_Grad2_Layer4_CH0_)
        ...
        Output_Grad2_Layer4_CH1_16 = flip_lines_16(Output_Grad2_Layer4_CH1_)
        ...
        Output_Grad3_Layer4_CH0_16 = flip_lines_16(Output_Grad3_Layer4_CH0_)
        ...
        Output_Grad3_Layer4_CH1_16 = flip_lines_16(Output_Grad3_Layer4_CH1_)
        ...
        Output_Grad4_Layer4_CH0_16 = flip_lines_16(Output_Grad4_Layer4_CH0_)
        ...
        Output_Grad4_Layer4_CH1_16 = flip_lines_16(Output_Grad4_Layer4_CH1_)
        ...
        Output_Grad5_Layer4_CH0_16 = flip_lines_16(Output_Grad5_Layer4_CH0_)
        ...
        Output_Grad5_Layer4_CH1_16 = flip_lines_16(Output_Grad5_Layer4_CH1_)
        ...
        Output_Grad6_Layer4_CH0_16 = flip_lines_16(Output_Grad6_Layer4_CH0_)
        ...
        Output_Grad6_Layer4_CH1_16 = flip_lines_16(Output_Grad6_Layer4_CH1_)
        ...
        Output_Grad7_Layer4_CH0_16 = flip_lines_16(Output_Grad7_Layer4_CH0_)
        ...
        Output_Grad7_Layer4_CH1_16 = flip_lines_16(Output_Grad7_Layer4_CH1_)
        ...
        Output_Grad8_Layer4_CH0_16 = flip_lines_16(Output_Grad8_Layer4_CH0_)
        ...
        Output_Grad8_Layer4_CH1_16 = flip_lines_16(Output_Grad8_Layer4_CH1_)
        ...
        # BReLu Marking
        s = time.time()
        ReLu_Marking1_Layer3_CH0 = Read_DDR0(Rd_Address=0x87D2C000,  End_Address=0x87D46000)
        ReLu_Marking1_Layer3_CH0_256 = data_32_to_16(ReLu_Marking1_Layer3_CH0)

        ReLu_Marking2_Layer3_CH0 = Read_DDR0(Rd_Address=0x87D46000,  End_Address=0x87D60000)
        ReLu_Marking2_Layer3_CH0_256 = data_32_to_16(ReLu_Marking2_Layer3_CH0)

        ReLu_Marking3_Layer3_CH0 = Read_DDR0(Rd_Address=0x87D60000,  End_Address=0x87D7A000)
        ReLu_Marking3_Layer3_CH0_256 = data_32_to_16(ReLu_Marking3_Layer3_CH0)

        ReLu_Marking4_Layer3_CH0 = Read_DDR0(Rd_Address=0x87D7A000,  End_Address=0x87D94000)
        ReLu_Marking4_Layer3_CH0_256 = data_32_to_16(ReLu_Marking4_Layer3_CH0)

        ReLu_Marking5_Layer3_CH0 = Read_DDR0(Rd_Address=0x87D94000,  End_Address=0x87DAE000)
        ReLu_Marking5_Layer3_CH0_256 = data_32_to_16(ReLu_Marking5_Layer3_CH0)

        ReLu_Marking6_Layer3_CH0 = Read_DDR0(Rd_Address=0x87DAE000,  End_Address=0x87DC8000)
        ReLu_Marking6_Layer3_CH0_256 = data_32_to_16(ReLu_Marking6_Layer3_CH0)

        ReLu_Marking7_Layer3_CH0 = Read_DDR0(Rd_Address=0x87DC8000,  End_Address=0x87DE2000)
        ReLu_Marking7_Layer3_CH0_256 = data_32_to_16(ReLu_Marking7_Layer3_CH0)

        ReLu_Marking8_Layer3_CH0 = Read_DDR0(Rd_Address=0x87DE2000,  End_Address=0x87DFC000)
        ReLu_Marking8_Layer3_CH0_256 = data_32_to_16(ReLu_Marking8_Layer3_CH0)

        ReLu_Marking1_Layer3_CH1 = Read_DDR0(Rd_Address=0x97D2C000,  End_Address=0x97D46000)
        ReLu_Marking1_Layer3_CH1_256 = data_32_to_16(ReLu_Marking1_Layer3_CH1)

        ReLu_Marking2_Layer3_CH1 = Read_DDR0(Rd_Address=0x97D46000,  End_Address=0x97D60000)
        ReLu_Marking2_Layer3_CH1_256 = data_32_to_16(ReLu_Marking2_Layer3_CH1)

        ReLu_Marking3_Layer3_CH1 = Read_DDR0(Rd_Address=0x97D60000,  End_Address=0x97D7A000)
        ReLu_Marking3_Layer3_CH1_256 = data_32_to_16(ReLu_Marking3_Layer3_CH1)

        ReLu_Marking4_Layer3_CH1 = Read_DDR0(Rd_Address=0x97D7A000,  End_Address=0x97D94000)
        ReLu_Marking4_Layer3_CH1_256 = data_32_to_16(ReLu_Marking4_Layer3_CH1)

        ReLu_Marking5_Layer3_CH1 = Read_DDR0(Rd_Address=0x97D94000,  End_Address=0x97DAE000)
        ReLu_Marking5_Layer3_CH1_256 = data_32_to_16(ReLu_Marking5_Layer3_CH1)

        ReLu_Marking6_Layer3_CH1 = Read_DDR0(Rd_Address=0x97DAE000,  End_Address=0x97DC8000)
        ReLu_Marking6_Layer3_CH1_256 = data_32_to_16(ReLu_Marking6_Layer3_CH1)

        ReLu_Marking7_Layer3_CH1 = Read_DDR0(Rd_Address=0x97DC8000,  End_Address=0x97DE2000)
        ReLu_Marking7_Layer3_CH1_256 = data_32_to_16(ReLu_Marking7_Layer3_CH1)

        ReLu_Marking8_Layer3_CH1 = Read_DDR0(Rd_Address=0x97DE2000,  End_Address=0x97DFC000)
        ...
        Weight_Gradient1_Layer4_CH0_256 = flip_lines_16(Weight_Gradient1_Layer4_CH0)
        ...
        Weight_Gradient2_Layer4_CH0_256 = flip_lines_16(Weight_Gradient2_Layer4_CH0)
        ...
        Weight_Gradient3_Layer4_CH0_256 = flip_lines_16(Weight_Gradient3_Layer4_CH0)
        ...
        Weight_Gradient4_Layer4_CH0_256 = flip_lines_16(Weight_Gradient4_Layer4_CH0)
        ...
        Weight_Gradient5_Layer4_CH0_256 = flip_lines_16(Weight_Gradient5_Layer4_CH0)
        ...
        Weight_Gradient6_Layer4_CH0_256 = flip_lines_16(Weight_Gradient6_Layer4_CH0)
        ...
        Weight_Gradient7_Layer4_CH0_256 = flip_lines_16(Weight_Gradient7_Layer4_CH0)
        ...
        Weight_Gradient8_Layer4_CH0_256 = flip_lines_16(Weight_Gradient8_Layer4_CH0)
        ...
        Weight_Gradient1_Layer4_CH1_256 = flip_lines_16(Weight_Gradient1_Layer4_CH1)
        ...
        Weight_Gradient2_Layer4_CH1_256 = flip_lines_16(Weight_Gradient2_Layer4_CH1)
        ...
        Weight_Gradient3_Layer4_CH1_256 = flip_lines_16(Weight_Gradient3_Layer4_CH1)
        ...
        Weight_Gradient4_Layer4_CH1_256 = flip_lines_16(Weight_Gradient4_Layer4_CH1)
        ...
        Weight_Gradient5_Layer4_CH1_256 = flip_lines_16(Weight_Gradient5_Layer4_CH1)
        ...
        Weight_Gradient6_Layer4_CH1_256 = flip_lines_16(Weight_Gradient6_Layer4_CH1)
        ...
        Weight_Gradient7_Layer4_CH1_256 = flip_lines_16(Weight_Gradient7_Layer4_CH1)
        ...
        Weight_Gradient8_Layer4_CH1_256 = flip_lines_16(Weight_Gradient8_Layer4_CH1)
        ...
        # BReLu Marking
        s = time.time()
        ReLu_Marking1_Layer2_CH0 = Read_DDR0(Rd_Address=0x87B8C000,  End_Address=0x87BC0000)
        ReLu_Marking1_Layer2_CH0_256 = data_32_to_16(ReLu_Marking1_Layer2_CH0)

        ReLu_Marking2_Layer2_CH0 = Read_DDR0(Rd_Address=0x87BC0000,  End_Address=0x87BF4000)
        ReLu_Marking2_Layer2_CH0_256 = data_32_to_16(ReLu_Marking2_Layer2_CH0)

        ReLu_Marking3_Layer2_CH0 = Read_DDR0(Rd_Address=0x87BF4000,  End_Address=0x87C28000)
        ReLu_Marking3_Layer2_CH0_256 = data_32_to_16(ReLu_Marking3_Layer2_CH0)

        ReLu_Marking4_Layer2_CH0 = Read_DDR0(Rd_Address=0x87C28000,  End_Address=0x87C5C000)
        ReLu_Marking4_Layer2_CH0_256 = data_32_to_16(ReLu_Marking4_Layer2_CH0)

        ReLu_Marking5_Layer2_CH0 = Read_DDR0(Rd_Address=0x87C5C000,  End_Address=0x87C90000)
        ReLu_Marking5_Layer2_CH0_256 = data_32_to_16(ReLu_Marking5_Layer2_CH0)

        ReLu_Marking6_Layer2_CH0 = Read_DDR0(Rd_Address=0x87C90000,  End_Address=0x87CC4000)
        ReLu_Marking6_Layer2_CH0_256 = data_32_to_16(ReLu_Marking6_Layer2_CH0)

        ReLu_Marking7_Layer2_CH0 = Read_DDR0(Rd_Address=0x87CC4000,  End_Address=0x87CF8000)
        ReLu_Marking7_Layer2_CH0_256 = data_32_to_16(ReLu_Marking7_Layer2_CH0)

        ReLu_Marking8_Layer2_CH0 = Read_DDR0(Rd_Address=0x87CF8000,  End_Address=0x87D2C000)
        ReLu_Marking8_Layer2_CH0_256 = data_32_to_16(ReLu_Marking8_Layer2_CH0)

        ReLu_Marking1_Layer2_CH1 = Read_DDR0(Rd_Address=0x97B8C000,  End_Address=0x97BC0000)
        ReLu_Marking1_Layer2_CH1_256 = data_32_to_16(ReLu_Marking1_Layer2_CH1)

        ReLu_Marking2_Layer2_CH1 = Read_DDR0(Rd_Address=0x97BC0000,  End_Address=0x97BF4000)
        ReLu_Marking2_Layer2_CH1_256 = data_32_to_16(ReLu_Marking2_Layer2_CH1)

        ReLu_Marking3_Layer2_CH1 = Read_DDR0(Rd_Address=0x97BF4000,  End_Address=0x97C28000)
        ReLu_Marking3_Layer2_CH1_256 = data_32_to_16(ReLu_Marking3_Layer2_CH1)

        ReLu_Marking4_Layer2_CH1 = Read_DDR0(Rd_Address=0x97C28000,  End_Address=0x97C5C000)
        ReLu_Marking4_Layer2_CH1_256 = data_32_to_16(ReLu_Marking4_Layer2_CH1)

        ReLu_Marking5_Layer2_CH1 = Read_DDR0(Rd_Address=0x97C5C000,  End_Address=0x97C90000)
        ReLu_Marking5_Layer2_CH1_256 = data_32_to_16(ReLu_Marking5_Layer2_CH1)

        ReLu_Marking6_Layer2_CH1 = Read_DDR0(Rd_Address=0x97C90000,  End_Address=0x97CC4000)
        ReLu_Marking6_Layer2_CH1_256 = data_32_to_16(ReLu_Marking6_Layer2_CH1)

        ReLu_Marking7_Layer2_CH1 = Read_DDR0(Rd_Address=0x97CC4000,  End_Address=0x97CF8000)
        ReLu_Marking7_Layer2_CH1_256 = data_32_to_16(ReLu_Marking7_Layer2_CH1)

        ReLu_Marking8_Layer2_CH1 = Read_DDR0(Rd_Address=0x97CF8000,  End_Address=0x97D2C000)
        ...
        Weight_Gradient1_Layer3_CH0_256 = flip_lines_16(Weight_Gradient1_Layer3_CH0)
        ...
        Weight_Gradient2_Layer3_CH0_256 = flip_lines_16(Weight_Gradient2_Layer3_CH0)
        ...
        Weight_Gradient3_Layer3_CH0_256 = flip_lines_16(Weight_Gradient3_Layer3_CH0)
        ...
        Weight_Gradient4_Layer3_CH0_256 = flip_lines_16(Weight_Gradient4_Layer3_CH0)
        ...
        Weight_Gradient5_Layer3_CH0_256 = flip_lines_16(Weight_Gradient5_Layer3_CH0)
        ...
        Weight_Gradient6_Layer3_CH0_256 = flip_lines_16(Weight_Gradient6_Layer3_CH0)
        ...
        Weight_Gradient7_Layer3_CH0_256 = flip_lines_16(Weight_Gradient7_Layer3_CH0)
        ...
        Weight_Gradient8_Layer3_CH0_256 = flip_lines_16(Weight_Gradient8_Layer3_CH0)
        ...
        Weight_Gradient1_Layer3_CH1_256 = flip_lines_16(Weight_Gradient1_Layer3_CH1)
        ...
        Weight_Gradient2_Layer3_CH1_256 = flip_lines_16(Weight_Gradient2_Layer3_CH1)
        ...
        Weight_Gradient3_Layer3_CH1_256 = flip_lines_16(Weight_Gradient3_Layer3_CH1)
        ...
        Weight_Gradient4_Layer3_CH1_256 = flip_lines_16(Weight_Gradient4_Layer3_CH1)
        ...
        Weight_Gradient5_Layer3_CH1_256 = flip_lines_16(Weight_Gradient5_Layer3_CH1)
        ...
        Weight_Gradient6_Layer3_CH1_256 = flip_lines_16(Weight_Gradient6_Layer3_CH1)
        ...
        Weight_Gradient7_Layer3_CH1_256 = flip_lines_16(Weight_Gradient7_Layer3_CH1)
        ...
        Weight_Gradient8_Layer3_CH1_256 = flip_lines_16(Weight_Gradient8_Layer3_CH1)
        ...
        # BReLu Marking
        s = time.time()
        ReLu_Marking1_Layer1_CH0 = Read_DDR0(Rd_Address=0x8784C000,  End_Address=0x878B4000)
        ReLu_Marking1_Layer1_CH0_256 = data_32_to_16(ReLu_Marking1_Layer1_CH0)

        ReLu_Marking2_Layer1_CH0 = Read_DDR0(Rd_Address=0x878B4000,  End_Address=0x8791C000)
        ReLu_Marking2_Layer1_CH0_256 = data_32_to_16(ReLu_Marking2_Layer1_CH0)

        ReLu_Marking3_Layer1_CH0 = Read_DDR0(Rd_Address=0x8791C000,  End_Address=0x87984000)
        ReLu_Marking3_Layer1_CH0_256 = data_32_to_16(ReLu_Marking3_Layer1_CH0)

        ReLu_Marking4_Layer1_CH0 = Read_DDR0(Rd_Address=0x87984000,  End_Address=0x879EC000)
        ReLu_Marking4_Layer1_CH0_256 = data_32_to_16(ReLu_Marking4_Layer1_CH0)

        ReLu_Marking5_Layer1_CH0 = Read_DDR0(Rd_Address=0x879EC000,  End_Address=0x87A54000)
        ReLu_Marking5_Layer1_CH0_256 = data_32_to_16(ReLu_Marking5_Layer1_CH0)

        ReLu_Marking6_Layer1_CH0 = Read_DDR0(Rd_Address=0x87A54000,  End_Address=0x87ABC000)
        ReLu_Marking6_Layer1_CH0_256 = data_32_to_16(ReLu_Marking6_Layer1_CH0)

        ReLu_Marking7_Layer1_CH0 = Read_DDR0(Rd_Address=0x87ABC000,  End_Address=0x87B24000)
        ReLu_Marking7_Layer1_CH0_256 = data_32_to_16(ReLu_Marking7_Layer1_CH0)

        ReLu_Marking8_Layer1_CH0 = Read_DDR0(Rd_Address=0x87B24000,  End_Address=0x87B8C000)
        ReLu_Marking8_Layer1_CH0_256 = data_32_to_16(ReLu_Marking8_Layer1_CH0)

        ReLu_Marking1_Layer1_CH1 = Read_DDR0(Rd_Address=0x9784C000,  End_Address=0x978B4000)
        ReLu_Marking1_Layer1_CH1_256 = data_32_to_16(ReLu_Marking1_Layer1_CH1)

        ReLu_Marking2_Layer1_CH1 = Read_DDR0(Rd_Address=0x978B4000,  End_Address=0x9791C000)
        ReLu_Marking2_Layer1_CH1_256 = data_32_to_16(ReLu_Marking2_Layer1_CH1)

        ReLu_Marking3_Layer1_CH1 = Read_DDR0(Rd_Address=0x9791C000,  End_Address=0x97984000)
        ReLu_Marking3_Layer1_CH1_256 = data_32_to_16(ReLu_Marking3_Layer1_CH1)

        ReLu_Marking4_Layer1_CH1 = Read_DDR0(Rd_Address=0x97984000,  End_Address=0x979EC000)
        ReLu_Marking4_Layer1_CH1_256 = data_32_to_16(ReLu_Marking4_Layer1_CH1)

        ReLu_Marking5_Layer1_CH1 = Read_DDR0(Rd_Address=0x979EC000,  End_Address=0x97A54000)
        ReLu_Marking5_Layer1_CH1_256 = data_32_to_16(ReLu_Marking5_Layer1_CH1)

        ReLu_Marking6_Layer1_CH1 = Read_DDR0(Rd_Address=0x97A54000,  End_Address=0x97ABC000)
        ReLu_Marking6_Layer1_CH1_256 = data_32_to_16(ReLu_Marking6_Layer1_CH1)

        ReLu_Marking7_Layer1_CH1 = Read_DDR0(Rd_Address=0x97ABC000,  End_Address=0x97B24000)
        ReLu_Marking7_Layer1_CH1_256 = data_32_to_16(ReLu_Marking7_Layer1_CH1)

        ReLu_Marking8_Layer1_CH1 = Read_DDR0(Rd_Address=0x97B24000,  End_Address=0x97B8C000)
        ...
        re = time.time()
        if DEBUG: print("Split : ", re-rs)
        gs = time.time()
        grad_relu_output = backward_active(Output_Grad_Layer2, relu_mask)
        ge = time.time()
        if DEBUG: print("Grad : ", ge-gs)
        ms = time.time() 
        grad_maxpool_output = backward_MaxPool_Location(grad_relu_output, location_mask)
        me = time.time()
        if DEBUG: print("UNMAXPooling : ", me-ms)
        bs = time.time()
        dL_dgamma_1, dL_dbeta_1, avg_pc_1, backward_const_1, gamma_1 = backward_LightNorm(grad_maxpool_output, layer1_cache)
        be = time.time()
        ...
        Weight_Gradient1_Layer2_CH0_256 = flip_lines_16(Weight_Gradient1_Layer2_CH0)
        ...
        Weight_Gradient2_Layer2_CH0_256 = flip_lines_16(Weight_Gradient2_Layer2_CH0)
        ...
        Weight_Gradient3_Layer2_CH0_256 = flip_lines_16(Weight_Gradient3_Layer2_CH0)
        ...
        Weight_Gradient4_Layer2_CH0_256 = flip_lines_16(Weight_Gradient4_Layer2_CH0)
        ...
        Weight_Gradient5_Layer2_CH0_256 = flip_lines_16(Weight_Gradient5_Layer2_CH0)
        ...
        Weight_Gradient6_Layer2_CH0_256 = flip_lines_16(Weight_Gradient6_Layer2_CH0)
        ...
        Weight_Gradient7_Layer2_CH0_256 = flip_lines_16(Weight_Gradient7_Layer2_CH0)
        ...
        Weight_Gradient8_Layer2_CH0_256 = flip_lines_16(Weight_Gradient8_Layer2_CH0)
        ...
        Weight_Gradient1_Layer2_CH1_256 = flip_lines_16(Weight_Gradient1_Layer2_CH1)
        ...
        Weight_Gradient2_Layer2_CH1_256 = flip_lines_16(Weight_Gradient2_Layer2_CH1)
        ...
        Weight_Gradient3_Layer2_CH1_256 = flip_lines_16(Weight_Gradient3_Layer2_CH1)
        ...
        Weight_Gradient4_Layer2_CH1_256 = flip_lines_16(Weight_Gradient4_Layer2_CH1)
        ...
        Weight_Gradient5_Layer2_CH1_256 = flip_lines_16(Weight_Gradient5_Layer2_CH1)
        ...
        Weight_Gradient6_Layer2_CH1_256 = flip_lines_16(Weight_Gradient6_Layer2_CH1)
        ...
        Weight_Gradient7_Layer2_CH1_256 = flip_lines_16(Weight_Gradient7_Layer2_CH1)
        ...
        Weight_Gradient8_Layer2_CH1_256 = flip_lines_16(Weight_Gradient8_Layer2_CH1)
        ...
        # BReLu Marking
        s = time.time()
        ReLu_Marking1_Layer0_CH0 = Read_DDR0(Rd_Address=0x871CC000,  End_Address=0x8729C000)
        ReLu_Marking1_Layer0_CH0_256 = data_32_to_16(ReLu_Marking1_Layer0_CH0)

        ReLu_Marking2_Layer0_CH0 = Read_DDR0(Rd_Address=0x8729C000,  End_Address=0x8736C000)
        ReLu_Marking2_Layer0_CH0_256 = data_32_to_16(ReLu_Marking2_Layer0_CH0)

        ReLu_Marking3_Layer0_CH0 = Read_DDR0(Rd_Address=0x8736C000,  End_Address=0x8743C000)
        ReLu_Marking3_Layer0_CH0_256 = data_32_to_16(ReLu_Marking3_Layer0_CH0)

        ReLu_Marking4_Layer0_CH0 = Read_DDR0(Rd_Address=0x8743C000,  End_Address=0x8750C000)
        ReLu_Marking4_Layer0_CH0_256 = data_32_to_16(ReLu_Marking4_Layer0_CH0)

        ReLu_Marking5_Layer0_CH0 = Read_DDR0(Rd_Address=0x8750C000,  End_Address=0x875DC000)
        ReLu_Marking5_Layer0_CH0_256 = data_32_to_16(ReLu_Marking5_Layer0_CH0)

        ReLu_Marking6_Layer0_CH0 = Read_DDR0(Rd_Address=0x875DC000,  End_Address=0x876AC000)
        ReLu_Marking6_Layer0_CH0_256 = data_32_to_16(ReLu_Marking6_Layer0_CH0)

        ReLu_Marking7_Layer0_CH0 = Read_DDR0(Rd_Address=0x876AC000,  End_Address=0x8777C000)
        ReLu_Marking7_Layer0_CH0_256 = data_32_to_16(ReLu_Marking7_Layer0_CH0)

        ReLu_Marking8_Layer0_CH0 = Read_DDR0(Rd_Address=0x8777C000,  End_Address=0x8784C000)
        ReLu_Marking8_Layer0_CH0_256 = data_32_to_16(ReLu_Marking8_Layer0_CH0)

        ReLu_Marking1_Layer0_CH1 = Read_DDR0(Rd_Address=0x971CC000,  End_Address=0x9729C000)
        ReLu_Marking1_Layer0_CH1_256 = data_32_to_16(ReLu_Marking1_Layer0_CH1)

        ReLu_Marking2_Layer0_CH1 = Read_DDR0(Rd_Address=0x9729C000,  End_Address=0x9736C000)
        ReLu_Marking2_Layer0_CH1_256 = data_32_to_16(ReLu_Marking2_Layer0_CH1)

        ReLu_Marking3_Layer0_CH1 = Read_DDR0(Rd_Address=0x9736C000,  End_Address=0x9743C000)
        ReLu_Marking3_Layer0_CH1_256 = data_32_to_16(ReLu_Marking3_Layer0_CH1)

        ReLu_Marking4_Layer0_CH1 = Read_DDR0(Rd_Address=0x9743C000,  End_Address=0x9750C000)
        ReLu_Marking4_Layer0_CH1_256 = data_32_to_16(ReLu_Marking4_Layer0_CH1)

        ReLu_Marking5_Layer0_CH1 = Read_DDR0(Rd_Address=0x9750C000,  End_Address=0x975DC000)
        ReLu_Marking5_Layer0_CH1_256 = data_32_to_16(ReLu_Marking5_Layer0_CH1)

        ReLu_Marking6_Layer0_CH1 = Read_DDR0(Rd_Address=0x975DC000,  End_Address=0x976AC000)
        ReLu_Marking6_Layer0_CH1_256 = data_32_to_16(ReLu_Marking6_Layer0_CH1)

        ReLu_Marking7_Layer0_CH1 = Read_DDR0(Rd_Address=0x976AC000,  End_Address=0x9777C000)
        ReLu_Marking7_Layer0_CH1_256 = data_32_to_16(ReLu_Marking7_Layer0_CH1)

        ReLu_Marking8_Layer0_CH1 = Read_DDR0(Rd_Address=0x9777C000,  End_Address=0x9784C000)
        ...
        Weight_Gradient1_Layer1_CH0_256 = flip_lines_16(Weight_Gradient1_Layer1_CH0)
        ...
        Weight_Gradient2_Layer1_CH0_256 = flip_lines_16(Weight_Gradient2_Layer1_CH0)
        ...
        Weight_Gradient3_Layer1_CH0_256 = flip_lines_16(Weight_Gradient3_Layer1_CH0)
        ...
        Weight_Gradient4_Layer1_CH0_256 = flip_lines_16(Weight_Gradient4_Layer1_CH0)
        ...
        Weight_Gradient5_Layer1_CH0_256 = flip_lines_16(Weight_Gradient5_Layer1_CH0)
        ...
        Weight_Gradient6_Layer1_CH0_256 = flip_lines_16(Weight_Gradient6_Layer1_CH0)
        ...
        Weight_Gradient7_Layer1_CH0_256 = flip_lines_16(Weight_Gradient7_Layer1_CH0)
        ...
        Weight_Gradient8_Layer1_CH0_256 = flip_lines_16(Weight_Gradient8_Layer1_CH0)
        ...
        Weight_Gradient1_Layer1_CH1_256 = flip_lines_16(Weight_Gradient1_Layer1_CH1)
        ...
        Weight_Gradient2_Layer1_CH1_256 = flip_lines_16(Weight_Gradient2_Layer1_CH1)
        ...
        Weight_Gradient3_Layer1_CH1_256 = flip_lines_16(Weight_Gradient3_Layer1_CH1)
        ...
        Weight_Gradient4_Layer1_CH1_256 = flip_lines_16(Weight_Gradient4_Layer1_CH1)
        ...
        Weight_Gradient5_Layer1_CH1_256 = flip_lines_16(Weight_Gradient5_Layer1_CH1)
        ...
        Weight_Gradient6_Layer1_CH1_256 = flip_lines_16(Weight_Gradient6_Layer1_CH1)
        ...
        Weight_Gradient7_Layer1_CH1_256 = flip_lines_16(Weight_Gradient7_Layer1_CH1)
        ...
        Weight_Gradient8_Layer1_CH1_256 = flip_lines_16(Weight_Gradient8_Layer1_CH1)
        ...
        Output_Grad6_Layer0_CH1 = flip_lines_16(Output_Grad6_Layer0_CH1)

        Output_Grad7_Layer0_CH0 = Read_DDR(Rd_Address=0xA704000,  End_Address=0xAA44000)
        Output_Grad7_Layer0_CH0 = flip_lines_16(Output_Grad7_Layer0_CH0)

        Output_Grad7_Layer0_CH1 = Read_DDR(Rd_Address=0x1A704000,  End_Address=0x1AA44000)
        Output_Grad7_Layer0_CH1 = flip_lines_16(Output_Grad7_Layer0_CH1)

        Output_Grad8_Layer0_CH0 = Read_DDR(Rd_Address=0xAA44000,  End_Address=0xAD84000)
        Output_Grad8_Layer0_CH0 = flip_lines_16(Output_Grad8_Layer0_CH0)

        Output_Grad8_Layer0_CH1 = Read_DDR(Rd_Address=0x1AA44000,  End_Address=0x1AD84000)
        Output_Grad8_Layer0_CH1 = flip_lines_16(Output_Grad8_Layer0_CH1)
        ...
        # Weight Gradient
        s = time.time()
        Weight_Gradient1_Layer0_CH0 = Read_DDR0(Rd_Address=0x8FBD9000,  End_Address=0x8FBD9900)
        ...
        Weight_Gradient2_Layer0_CH0 = Read_DDR0(Rd_Address=0x8FBD9900,  End_Address=0x8FBDA200)
        ...
        Weight_Gradient3_Layer0_CH0 = Read_DDR0(Rd_Address=0x8FBDA200,  End_Address=0x8FBDAB00)
        ...
        Weight_Gradient4_Layer0_CH0 = Read_DDR0(Rd_Address=0x8FBDAB00,  End_Address=0x8FBDB400)
        ...
        Weight_Gradient5_Layer0_CH0 = Read_DDR0(Rd_Address=0x8FBDB400,  End_Address=0x8FBDBD00)
        ...
        Weight_Gradient6_Layer0_CH0 = Read_DDR0(Rd_Address=0x8FBDBD00,  End_Address=0x8FBDC600)
        ...
        Weight_Gradient7_Layer0_CH0 = Read_DDR0(Rd_Address=0x8FBDC600,  End_Address=0x8FBDCF00)
        ...
        Weight_Gradient8_Layer0_CH0 = Read_DDR0(Rd_Address=0x8FBDCF00,  End_Address=0x8FBDD800)
        ...
        Weight_Gradient1_Layer0_CH1 = Read_DDR0(Rd_Address=0x9FBD9000,  End_Address=0x9FBD9900)
        ...
        Weight_Gradient2_Layer0_CH1 = Read_DDR0(Rd_Address=0x9FBD9900,  End_Address=0x9FBDA200)
        ...
        Weight_Gradient3_Layer0_CH1 = Read_DDR0(Rd_Address=0x9FBDA200,  End_Address=0x9FBDAB00)
        ...
        Weight_Gradient4_Layer0_CH1 = Read_DDR0(Rd_Address=0x9FBDAB00,  End_Address=0x9FBDB400)
        ...
        Weight_Gradient5_Layer0_CH1 = Read_DDR0(Rd_Address=0x9FBDB400,  End_Address=0x9FBDBD00)
        ...
        Weight_Gradient6_Layer0_CH1 = Read_DDR0(Rd_Address=0x9FBDBD00,  End_Address=0x9FBDC600)
        ...
        Weight_Gradient7_Layer0_CH1 = Read_DDR0(Rd_Address=0x9FBDC600,  End_Address=0x9FBDCF00)
        ...
        Weight_Gradient8_Layer0_CH1 = Read_DDR0(Rd_Address=0x9FBDCF00,  End_Address=0x9FBDD800)
        ...
        Weight_Gradient_Layer0 = [sum(map(float, item)) for item in zip(*Weight_Gradient_Layer0)]   
    ...
    def Write_Weight(self, data):
        ...
        if DEBUG2 : Save_File(data.Weight_Dec[0],"result/Weight0")
        if DEBUG2 : Save_File(data.Weight_Dec[1],"result/Weight1")
        if DEBUG2 : Save_File(data.Weight_Dec[2],"result/Weight2")
        if DEBUG2 : Save_File(data.Weight_Dec[3],"result/Weight3")
        if DEBUG2 : Save_File(data.Weight_Dec[4],"result/Weight4")
        if DEBUG2 : Save_File(data.Weight_Dec[5],"result/Weight5")
        if DEBUG2 : Save_File(data.Weight_Dec[6],"result/Weight6")
        if DEBUG2 : Save_File(data.Weight_Dec[7],"result/Weight7")
        if DEBUG2 : Save_File(data.Weight_Dec[8],"result/Weight8")
    ...
    def Forward_Infer(self,data):
        ...
        if DEBUG2: 
            ...
            print("Data : ", Layer8_1st_Iter_Image8_CH1[0:2])
