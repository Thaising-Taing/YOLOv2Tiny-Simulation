...
class Simulation(object):
    ...
    def Forward(self, data):
        ...
        if self.save_debug_data: Save_File("/home/msis/Desktop/Python/yolov2/Output_Sim_PyTorch/Input_Image", im_data)
        temp_Out[0], temp_cache['0'] = Torch_Conv_Pool.forward(im_data, Weight_Tensor[0], conv_param, pool_param_stride2)
        if self.save_debug_data: Save_File("/home/msis/Desktop/Python/yolov2/Output_Sim_PyTorch/Output_1st_Iter_Layer0", temp_Out[0])
        ...
        if self.save_debug_data: Save_File("/home/msis/Desktop/Python/yolov2/Output_Sim_PyTorch/Output_2nd_Iter_Layer0", Out0)
        if self.save_debug_data: Save_File("/home/msis/Desktop/Python/yolov2/Output_Sim_PyTorch/Weight_Layer0_Before", Weight_Tensor[0])
        if self.save_debug_data: Save_File("/home/msis/Desktop/Python/yolov2/Output_Sim_PyTorch/Beta_Layer0_Before", Beta_Tensor[0])
        if self.save_debug_data: Save_File("/home/msis/Desktop/Python/yolov2/Output_Sim_PyTorch/Gamma_Layer0_Before", Gamma_Tensor[0])

        # Layer1: Conv-BN-ReLU-Pool
        temp_Out[1], temp_cache['1'] = Torch_FastConv.forward(Out0, Weight_Tensor[1], conv_param)
        if self.save_debug_data: Save_File("/home/msis/Desktop/Python/yolov2/Output_Sim_PyTorch/Output_1st_Iter_Layer1", temp_Out[1])
        ...
        if self.save_debug_data: Save_File("/home/msis/Desktop/Python/yolov2/Output_Sim_PyTorch/Output_1st_Iter_Layer1", Out1)
        ...
        Out7, cache['7'] = Torch_Conv_BatchNorm_ReLU.forward(Out6, Weight_Tensor[7], Gamma_Tensor[7], Beta_Tensor[7],
                                                            ...
                                                            mean, var, self.Mode)
        if self.save_debug_data: Save_File("/home/msis/Desktop/Python/yolov2/Output_Sim_PyTorch/Output_Layer7", Out7)
        ...
        self.out = Out8
        if self.save_debug_data: Save_File("/home/msis/Desktop/Python/yolov2/Output_Sim_PyTorch/Output_Layer8_FWD", self.out)
    ...
    def Calculate_Loss(self,data):
        ...
        if self.save_debug_data: Save_File("/home/msis/Desktop/Python/yolov2/Output_Sim_PyTorch/Loss_Grad", self.Loss_Gradient)
        if self.save_debug_data: Save_File("/home/msis/Desktop/Python/yolov2/Output_Sim_PyTorch/Loss", self.Loss)
    ...
    def Backward(self,data):
        ...
        if self.save_debug_data: Save_File("/home/msis/Desktop/Python/yolov2/Output_Sim_PyTorch/Input_Grad_Layer8", Input_Grad_Layer8)
        if self.save_debug_data: Save_File("/home/msis/Desktop/Python/yolov2/Output_Sim_PyTorch/Weight_Gradient_Layer8", Weight_Gradient_Layer8)
        if self.save_debug_data: Save_File("/home/msis/Desktop/Python/yolov2/Output_Sim_PyTorch/Bias_Grad", Bias_Grad)
        ...
        if self.save_debug_data: Save_File("/home/msis/Desktop/Python/yolov2/Output_Sim_PyTorch/Input_Grad_Layer7", Input_Grad_Layer7)
        if self.save_debug_data: Save_File("/home/msis/Desktop/Python/yolov2/Output_Sim_PyTorch/Weight_Gradient_Layer7", Weight_Gradient_Layer7)
        if self.save_debug_data: Save_File("/home/msis/Desktop/Python/yolov2/Output_Sim_PyTorch/Gamma_Gradient_Layer7", Gamma_Gradient_Layer7)
        if self.save_debug_data: Save_File("/home/msis/Desktop/Python/yolov2/Output_Sim_PyTorch/Beta_Gradient_Layer7", Beta_Gradient_Layer7)
        ...
        # if self.save_debug_data: Save_File("/home/msis/Desktop/Python/yolov2/Output_Sim_PyTorch/Output_Layer1_Backward", Input_Grad_Layer1)
