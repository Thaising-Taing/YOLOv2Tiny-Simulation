...
class Post_Processing:
    ...
    def __init__(self, Mode, Brain_Floating_Point, Exponent_Bits, Mantissa_Bits, Output_Layer8):
        self.Mode = Mode
        self.Brain_Floating_Point = Brain_Floating_Point
        self.Exponent_Bits = Exponent_Bits
        self.Mantissa_Bits = Mantissa_Bits
        self.Output_Layer8 = Output_Layer8
    ...
    def PostProcessing(self, gt_boxes, gt_classes, num_boxes):
        ...
        if self.Mode == "Training":
            ...
            Layer8_Loss, Layer8_Loss_Gradient = loss(self.Output_Layer8, gt_boxes=gt_boxes,
